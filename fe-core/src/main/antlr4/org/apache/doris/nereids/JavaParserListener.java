...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#importStar}.
	 * @param ctx the parse tree
	 */
	void enterImportStar(JavaParser.ImportStarContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#importStar}.
	 * @param ctx the parse tree
	 */
	void exitImportStar(JavaParser.ImportStarContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#arrayDeclarator}.
	 * @param ctx the parse tree
	 */
	void enterArrayDeclarator(JavaParser.ArrayDeclaratorContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#arrayDeclarator}.
	 * @param ctx the parse tree
	 */
	void exitArrayDeclarator(JavaParser.ArrayDeclaratorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#identifierAndTypeArguments}.
	 * @param ctx the parse tree
	 */
	void enterIdentifierAndTypeArguments(JavaParser.IdentifierAndTypeArgumentsContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#identifierAndTypeArguments}.
	 * @param ctx the parse tree
	 */
	void exitIdentifierAndTypeArguments(JavaParser.IdentifierAndTypeArgumentsContext ctx);
	/**
