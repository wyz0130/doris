...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#importStar}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitImportStar(JavaParser.ImportStarContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#arrayDeclarator}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayDeclarator(JavaParser.ArrayDeclaratorContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#identifierAndTypeArguments}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentifierAndTypeArguments(JavaParser.IdentifierAndTypeArgumentsContext ctx);
	/**
