            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.error_log = new java.util.ArrayList<java.lang.String>(_list182.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.delta_urls = new java.util.ArrayList<java.lang.String>(_list185.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem186;
                for (int _i187 = 0; _i187 < _list185.size; ++_i187)
                {
                  _elem186 = iprot.readString();
                  struct.delta_urls.add(_elem186);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.load_counters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map188.size);
                ...
                for (int _i191 = 0; _i191 < _map188.size; ++_i191)
                {
                  ...
                  struct.load_counters.put(_key189, _val190);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.export_files = new java.util.ArrayList<java.lang.String>(_list192.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem193;
                for (int _i194 = 0; _i194 < _list192.size; ++_i194)
                {
                  _elem193 = iprot.readString();
                  struct.export_files.add(_elem193);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list195.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem196;
                for (int _i197 = 0; _i197 < _list195.size; ++_i197)
                {
                  _elem196 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem196.read(iprot);
                  struct.commitInfos.add(_elem196);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errorTabletInfos = new java.util.ArrayList<org.apache.doris.thrift.TErrorTabletInfo>(_list198.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TErrorTabletInfo _elem199;
                for (int _i200 = 0; _i200 < _list198.size; ++_i200)
                {
                  _elem199 = new org.apache.doris.thrift.TErrorTabletInfo();
                  _elem199.read(iprot);
                  struct.errorTabletInfos.add(_elem199);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.detailed_report = new java.util.ArrayList<TDetailedReportParams>(_list201.size);
                @org.apache.thrift.annotation.Nullable TDetailedReportParams _elem202;
                for (int _i203 = 0; _i203 < _list201.size; ++_i203)
                {
                  _elem202 = new TDetailedReportParams();
                  _elem202.read(iprot);
                  struct.detailed_report.add(_elem202);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hive_partition_updates = new java.util.ArrayList<org.apache.doris.thrift.THivePartitionUpdate>(_list204.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.THivePartitionUpdate _elem205;
                for (int _i206 = 0; _i206 < _list204.size; ++_i206)
                {
                  _elem205 = new org.apache.doris.thrift.THivePartitionUpdate();
                  _elem205.read(iprot);
                  struct.hive_partition_updates.add(_elem205);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.error_log != null) {
        if (struct.isSetErrorLog()) {
          oprot.writeFieldBegin(ERROR_LOG_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter207 : struct.error_log)
            {
      ...
      if (struct.delta_urls != null) {
        if (struct.isSetDeltaUrls()) {
          oprot.writeFieldBegin(DELTA_URLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter208 : struct.delta_urls)
            {
      ...
      if (struct.load_counters != null) {
        if (struct.isSetLoadCounters()) {
          oprot.writeFieldBegin(LOAD_COUNTERS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter209 : struct.load_counters.entrySet())
            {
      ...
      if (struct.export_files != null) {
        if (struct.isSetExportFiles()) {
          oprot.writeFieldBegin(EXPORT_FILES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter210 : struct.export_files)
            {
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter211 : struct.commitInfos)
            {
      ...
      if (struct.errorTabletInfos != null) {
        if (struct.isSetErrorTabletInfos()) {
          oprot.writeFieldBegin(ERROR_TABLET_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TErrorTabletInfo _iter212 : struct.errorTabletInfos)
            {
      ...
      if (struct.detailed_report != null) {
        if (struct.isSetDetailedReport()) {
          oprot.writeFieldBegin(DETAILED_REPORT_FIELD_DESC);
          {
            ...
            for (TDetailedReportParams _iter213 : struct.detailed_report)
            {
      ...
      if (struct.hive_partition_updates != null) {
        if (struct.isSetHivePartitionUpdates()) {
          oprot.writeFieldBegin(HIVE_PARTITION_UPDATES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.THivePartitionUpdate _iter214 : struct.hive_partition_updates)
            {
      ...
      if (struct.isSetErrorLog()) {
        {
          ...
          for (java.lang.String _iter215 : struct.error_log)
          {
      ...
      if (struct.isSetDeltaUrls()) {
        {
          ...
          for (java.lang.String _iter216 : struct.delta_urls)
          {
      ...
      if (struct.isSetLoadCounters()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter217 : struct.load_counters.entrySet())
          {
      ...
      if (struct.isSetExportFiles()) {
        {
          ...
          for (java.lang.String _iter218 : struct.export_files)
          {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter219 : struct.commitInfos)
          {
      ...
      if (struct.isSetErrorTabletInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TErrorTabletInfo _iter220 : struct.errorTabletInfos)
          {
      ...
      if (struct.isSetDetailedReport()) {
        {
          ...
          for (TDetailedReportParams _iter221 : struct.detailed_report)
          {
      ...
      if (struct.isSetHivePartitionUpdates()) {
        {
          ...
          for (org.apache.doris.thrift.THivePartitionUpdate _iter222 : struct.hive_partition_updates)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.error_log = new java.util.ArrayList<java.lang.String>(_list223.size);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.delta_urls = new java.util.ArrayList<java.lang.String>(_list226.size);
          ...
          for (int _i228 = 0; _i228 < _list226.size; ++_i228)
          {
            ...
            struct.delta_urls.add(_elem227);
          }
        }
        struct.setDeltaUrlsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.load_counters = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map229.size);
          ...
          for (int _i232 = 0; _i232 < _map229.size; ++_i232)
          {
            ...
            struct.load_counters.put(_key230, _val231);
          }
        }
        struct.setLoadCountersIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.export_files = new java.util.ArrayList<java.lang.String>(_list233.size);
          ...
          for (int _i235 = 0; _i235 < _list233.size; ++_i235)
          {
            ...
            struct.export_files.add(_elem234);
          }
        }
        struct.setExportFilesIsSet(true);
      }
      if (incoming.get(11)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list236.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem237;
          for (int _i238 = 0; _i238 < _list236.size; ++_i238)
          {
            _elem237 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem237.read(iprot);
            struct.commitInfos.add(_elem237);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.errorTabletInfos = new java.util.ArrayList<org.apache.doris.thrift.TErrorTabletInfo>(_list239.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TErrorTabletInfo _elem240;
          for (int _i241 = 0; _i241 < _list239.size; ++_i241)
          {
            _elem240 = new org.apache.doris.thrift.TErrorTabletInfo();
            _elem240.read(iprot);
            struct.errorTabletInfos.add(_elem240);
          }
        }
        struct.setErrorTabletInfosIsSet(true);
      }
      ...
      if (incoming.get(20)) {
        {
          ...
          struct.detailed_report = new java.util.ArrayList<TDetailedReportParams>(_list242.size);
          @org.apache.thrift.annotation.Nullable TDetailedReportParams _elem243;
          for (int _i244 = 0; _i244 < _list242.size; ++_i244)
          {
            _elem243 = new TDetailedReportParams();
            _elem243.read(iprot);
            struct.detailed_report.add(_elem243);
          }
        }
        struct.setDetailedReportIsSet(true);
      }
      ...
      if (incoming.get(23)) {
        {
          ...
          struct.hive_partition_updates = new java.util.ArrayList<org.apache.doris.thrift.THivePartitionUpdate>(_list245.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.THivePartitionUpdate _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = new org.apache.doris.thrift.THivePartitionUpdate();
            _elem246.read(iprot);
            struct.hive_partition_updates.add(_elem246);
          }
        }
        struct.setHivePartitionUpdatesIsSet(true);
      }
