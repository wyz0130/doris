...
public class TGetTabletReplicaInfosResult implements org.apache.thrift.TBase<TGetTabletReplicaInfosResult, TGetTabletReplicaInfosResult._Fields>, java.io.Serializable, Cloneable, Comparable<TGetTabletReplicaInfosResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablet_replica_infos = new java.util.HashMap<java.lang.Long,java.util.List<org.apache.doris.thrift.TReplicaInfo>>(2*_map516.size);
                long _key517;
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TReplicaInfo> _val518;
                for (int _i519 = 0; _i519 < _map516.size; ++_i519)
                {
                  _key517 = iprot.readI64();
                  {
                    org.apache.thrift.protocol.TList _list520 = iprot.readListBegin();
                    _val518 = new java.util.ArrayList<org.apache.doris.thrift.TReplicaInfo>(_list520.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TReplicaInfo _elem521;
                    for (int _i522 = 0; _i522 < _list520.size; ++_i522)
                    {
                      _elem521 = new org.apache.doris.thrift.TReplicaInfo();
                      _elem521.read(iprot);
                      _val518.add(_elem521);
                    }
                    iprot.readListEnd();
                  }
                  struct.tablet_replica_infos.put(_key517, _val518);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.tablet_replica_infos != null) {
        if (struct.isSetTabletReplicaInfos()) {
          oprot.writeFieldBegin(TABLET_REPLICA_INFOS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.util.List<org.apache.doris.thrift.TReplicaInfo>> _iter523 : struct.tablet_replica_infos.entrySet())
            {
              oprot.writeI64(_iter523.getKey());
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter523.getValue().size()));
                for (org.apache.doris.thrift.TReplicaInfo _iter524 : _iter523.getValue())
                {
  ...
  private static class TGetTabletReplicaInfosResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGetTabletReplicaInfosResult> {
      ...
      if (struct.isSetTabletReplicaInfos()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.util.List<org.apache.doris.thrift.TReplicaInfo>> _iter525 : struct.tablet_replica_infos.entrySet())
          {
            oprot.writeI64(_iter525.getKey());
            {
              oprot.writeI32(_iter525.getValue().size());
              for (org.apache.doris.thrift.TReplicaInfo _iter526 : _iter525.getValue())
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetTabletReplicaInfosResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map527 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST); 
          struct.tablet_replica_infos = new java.util.HashMap<java.lang.Long,java.util.List<org.apache.doris.thrift.TReplicaInfo>>(2*_map527.size);
          long _key528;
          @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TReplicaInfo> _val529;
          for (int _i530 = 0; _i530 < _map527.size; ++_i530)
          {
            _key528 = iprot.readI64();
            {
              org.apache.thrift.protocol.TList _list531 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
              _val529 = new java.util.ArrayList<org.apache.doris.thrift.TReplicaInfo>(_list531.size);
              @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TReplicaInfo _elem532;
              for (int _i533 = 0; _i533 < _list531.size; ++_i533)
              {
                _elem532 = new org.apache.doris.thrift.TReplicaInfo();
                _elem532.read(iprot);
                _val529.add(_elem532);
              }
            }
            struct.tablet_replica_infos.put(_key528, _val529);
          }
        }
        struct.setTabletReplicaInfosIsSet(true);
      }
