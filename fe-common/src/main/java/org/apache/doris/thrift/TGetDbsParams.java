...
public class TGetDbsParams implements org.apache.thrift.TBase<TGetDbsParams, TGetDbsParams._Fields>, java.io.Serializable, Cloneable, Comparable<TGetDbsParams> {
  ...
  private static final org.apache.thrift.protocol.TField GET_NULL_CATALOG_FIELD_DESC = new org.apache.thrift.protocol.TField("get_null_catalog", org.apache.thrift.protocol.TType.BOOL, (short)6);
  ...
  public boolean get_null_catalog; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    GET_NULL_CATALOG((short)6, "get_null_catalog");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // CATALOG
          return CATALOG;
        case 6: // GET_NULL_CATALOG
          return GET_NULL_CATALOG;
        default:
          return null;
      }
    }
  ...
  private static final int __GET_NULL_CATALOG_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.PATTERN,_Fields.USER,_Fields.USER_IP,_Fields.CURRENT_USER_IDENT,_Fields.CATALOG,_Fields.GET_NULL_CATALOG};
  ...
  static {
    ...
    tmpMap.put(_Fields.CATALOG, new org.apache.thrift.meta_data.FieldMetaData("catalog", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.GET_NULL_CATALOG, new org.apache.thrift.meta_data.FieldMetaData("get_null_catalog", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TGetDbsParams(TGetDbsParams other) {
    ...
    this.get_null_catalog = other.get_null_catalog;
  }
  ...
  public void clear() {
    ...
    this.catalog = null;
    setGetNullCatalogIsSet(false);
    this.get_null_catalog = false;
  }
  ...
  public boolean isGetNullCatalog() {
    return this.get_null_catalog;
  }

  public TGetDbsParams setGetNullCatalog(boolean get_null_catalog) {
    this.get_null_catalog = get_null_catalog;
    setGetNullCatalogIsSet(true);
    return this;
  }

  public void unsetGetNullCatalog() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __GET_NULL_CATALOG_ISSET_ID);
  }

  /** Returns true if field get_null_catalog is set (has been assigned a value) and false otherwise */
  public boolean isSetGetNullCatalog() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __GET_NULL_CATALOG_ISSET_ID);
  }

  public void setGetNullCatalogIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __GET_NULL_CATALOG_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case GET_NULL_CATALOG:
      if (value == null) {
        unsetGetNullCatalog();
      } else {
        setGetNullCatalog((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TGetDbsParams that) {
    ...
    boolean this_present_get_null_catalog = true && this.isSetGetNullCatalog();
    boolean that_present_get_null_catalog = true && that.isSetGetNullCatalog();
    if (this_present_get_null_catalog || that_present_get_null_catalog) {
      if (!(this_present_get_null_catalog && that_present_get_null_catalog))
        return false;
      if (this.get_null_catalog != that.get_null_catalog)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetGetNullCatalog()) ? 131071 : 524287);
    if (isSetGetNullCatalog())
      hashCode = hashCode * 8191 + ((get_null_catalog) ? 131071 : 524287);
  ...
  public int compareTo(TGetDbsParams other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetGetNullCatalog(), other.isSetGetNullCatalog());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGetNullCatalog()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.get_null_catalog, other.get_null_catalog);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetGetNullCatalog()) {
      if (!first) sb.append(", ");
      sb.append("get_null_catalog:");
      sb.append(this.get_null_catalog);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TGetDbsParamsStandardScheme extends org.apache.thrift.scheme.StandardScheme<TGetDbsParams> {
        ...
        switch (schemeField.id) {
          ...
          case 6: // GET_NULL_CATALOG
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.get_null_catalog = iprot.readBool();
              struct.setGetNullCatalogIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TGetDbsParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetGetNullCatalog()) {
        oprot.writeFieldBegin(GET_NULL_CATALOG_FIELD_DESC);
        oprot.writeBool(struct.get_null_catalog);
        oprot.writeFieldEnd();
      }
