...
public class TMasterInfo implements org.apache.thrift.TBase<TMasterInfo, TMasterInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TMasterInfo> {
  ...
  private static final org.apache.thrift.protocol.TField FRONTEND_INFOS_FIELD_DESC = new org.apache.thrift.protocol.TField("frontend_infos", org.apache.thrift.protocol.TType.LIST, (short)9);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TFrontendInfo> frontend_infos; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    FRONTEND_INFOS((short)9, "frontend_infos");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // BACKEND_ID
          return BACKEND_ID;
        case 9: // FRONTEND_INFOS
          return FRONTEND_INFOS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.TOKEN,_Fields.BACKEND_IP,_Fields.HTTP_PORT,_Fields.HEARTBEAT_FLAGS,_Fields.BACKEND_ID,_Fields.FRONTEND_INFOS};
  ...
  static {
    ...
    tmpMap.put(_Fields.BACKEND_ID, new org.apache.thrift.meta_data.FieldMetaData("backend_id", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.FRONTEND_INFOS, new org.apache.thrift.meta_data.FieldMetaData("frontend_infos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFrontendInfo.class))));
  ...
  public TMasterInfo(TMasterInfo other) {
    ...
    if (other.isSetFrontendInfos()) {
      java.util.List<TFrontendInfo> __this__frontend_infos = new java.util.ArrayList<TFrontendInfo>(other.frontend_infos.size());
      for (TFrontendInfo other_element : other.frontend_infos) {
        __this__frontend_infos.add(new TFrontendInfo(other_element));
      }
      this.frontend_infos = __this__frontend_infos;
    }
  }
  ...
  public int getFrontendInfosSize() {
    return (this.frontend_infos == null) ? 0 : this.frontend_infos.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<TFrontendInfo> getFrontendInfosIterator() {
    return (this.frontend_infos == null) ? null : this.frontend_infos.iterator();
  }

  public void addToFrontendInfos(TFrontendInfo elem) {
    if (this.frontend_infos == null) {
      this.frontend_infos = new java.util.ArrayList<TFrontendInfo>();
    }
    this.frontend_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<TFrontendInfo> getFrontendInfos() {
    return this.frontend_infos;
  }

  public TMasterInfo setFrontendInfos(@org.apache.thrift.annotation.Nullable java.util.List<TFrontendInfo> frontend_infos) {
    this.frontend_infos = frontend_infos;
    return this;
  }

  public void unsetFrontendInfos() {
    this.frontend_infos = null;
  }

  /** Returns true if field frontend_infos is set (has been assigned a value) and false otherwise */
  public boolean isSetFrontendInfos() {
    return this.frontend_infos != null;
  }

  public void setFrontendInfosIsSet(boolean value) {
    if (!value) {
      this.frontend_infos = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FRONTEND_INFOS:
      if (value == null) {
        ...
        setFrontendInfos((java.util.List<TFrontendInfo>)value);
      }
      break;
  ...
  public boolean equals(TMasterInfo that) {
    ...
    boolean this_present_frontend_infos = true && this.isSetFrontendInfos();
    boolean that_present_frontend_infos = true && that.isSetFrontendInfos();
    if (this_present_frontend_infos || that_present_frontend_infos) {
      if (!(this_present_frontend_infos && that_present_frontend_infos))
        return false;
      if (!this.frontend_infos.equals(that.frontend_infos))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetFrontendInfos()) ? 131071 : 524287);
    if (isSetFrontendInfos())
      hashCode = hashCode * 8191 + frontend_infos.hashCode();
  ...
  public int compareTo(TMasterInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetFrontendInfos(), other.isSetFrontendInfos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFrontendInfos()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.frontend_infos, other.frontend_infos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetFrontendInfos()) {
      if (!first) sb.append(", ");
      sb.append("frontend_infos:");
      if (this.frontend_infos == null) {
        sb.append("null");
      } else {
        sb.append(this.frontend_infos);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TMasterInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TMasterInfo> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.frontend_infos = new java.util.ArrayList<TFrontendInfo>(_list0.size);
                @org.apache.thrift.annotation.Nullable TFrontendInfo _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new TFrontendInfo();
                  _elem1.read(iprot);
                  struct.frontend_infos.add(_elem1);
                }
                iprot.readListEnd();
              }
              struct.setFrontendInfosIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMasterInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.frontend_infos != null) {
        if (struct.isSetFrontendInfos()) {
          oprot.writeFieldBegin(FRONTEND_INFOS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.frontend_infos.size()));
            for (TFrontendInfo _iter3 : struct.frontend_infos)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TMasterInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMasterInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TMasterInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFrontendInfos()) {
        {
          oprot.writeI32(struct.frontend_infos.size());
          for (TFrontendInfo _iter4 : struct.frontend_infos)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.frontend_infos = new java.util.ArrayList<TFrontendInfo>(_list5.size);
          @org.apache.thrift.annotation.Nullable TFrontendInfo _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new TFrontendInfo();
            _elem6.read(iprot);
            struct.frontend_infos.add(_elem6);
          }
        }
        struct.setFrontendInfosIsSet(true);
      }
