...
public class TQueryStatsResult implements org.apache.thrift.TBase<TQueryStatsResult, TQueryStatsResult._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryStatsResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.simple_result = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map456.size);
                ...
                for (int _i459 = 0; _i459 < _map456.size; ++_i459)
                {
                  ...
                  struct.simple_result.put(_key457, _val458);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list460.size);
                @org.apache.thrift.annotation.Nullable TTableQueryStats _elem461;
                for (int _i462 = 0; _i462 < _list460.size; ++_i462)
                {
                  _elem461 = new TTableQueryStats();
                  _elem461.read(iprot);
                  struct.table_stats.add(_elem461);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_verbos_stats = new java.util.ArrayList<TTableIndexQueryStats>(_list463.size);
                @org.apache.thrift.annotation.Nullable TTableIndexQueryStats _elem464;
                for (int _i465 = 0; _i465 < _list463.size; ++_i465)
                {
                  _elem464 = new TTableIndexQueryStats();
                  _elem464.read(iprot);
                  struct.table_verbos_stats.add(_elem464);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablet_stats = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map466.size);
                long _key467;
                long _val468;
                for (int _i469 = 0; _i469 < _map466.size; ++_i469)
                {
                  ...
                  struct.tablet_stats.put(_key467, _val468);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.simple_result != null) {
        if (struct.isSetSimpleResult()) {
          oprot.writeFieldBegin(SIMPLE_RESULT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter470 : struct.simple_result.entrySet())
            {
      ...
      if (struct.table_stats != null) {
        if (struct.isSetTableStats()) {
          oprot.writeFieldBegin(TABLE_STATS_FIELD_DESC);
          {
            ...
            for (TTableQueryStats _iter471 : struct.table_stats)
            {
      ...
      if (struct.table_verbos_stats != null) {
        if (struct.isSetTableVerbosStats()) {
          oprot.writeFieldBegin(TABLE_VERBOS_STATS_FIELD_DESC);
          {
            ...
            for (TTableIndexQueryStats _iter472 : struct.table_verbos_stats)
            {
      ...
      if (struct.tablet_stats != null) {
        if (struct.isSetTabletStats()) {
          oprot.writeFieldBegin(TABLET_STATS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter473 : struct.tablet_stats.entrySet())
            {
  ...
  private static class TQueryStatsResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TQueryStatsResult> {
      ...
      if (struct.isSetSimpleResult()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Long> _iter474 : struct.simple_result.entrySet())
          {
      ...
      if (struct.isSetTableStats()) {
        {
          ...
          for (TTableQueryStats _iter475 : struct.table_stats)
          {
      ...
      if (struct.isSetTableVerbosStats()) {
        {
          ...
          for (TTableIndexQueryStats _iter476 : struct.table_verbos_stats)
          {
      ...
      if (struct.isSetTabletStats()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter477 : struct.tablet_stats.entrySet())
          {
            oprot.writeI64(_iter477.getKey());
            oprot.writeI64(_iter477.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TQueryStatsResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map478 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64); 
          struct.simple_result = new java.util.HashMap<java.lang.String,java.lang.Long>(2*_map478.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key479;
          long _val480;
          for (int _i481 = 0; _i481 < _map478.size; ++_i481)
          {
            _key479 = iprot.readString();
            _val480 = iprot.readI64();
            struct.simple_result.put(_key479, _val480);
          }
        }
        struct.setSimpleResultIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list482 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list482.size);
          @org.apache.thrift.annotation.Nullable TTableQueryStats _elem483;
          for (int _i484 = 0; _i484 < _list482.size; ++_i484)
          {
            _elem483 = new TTableQueryStats();
            _elem483.read(iprot);
            struct.table_stats.add(_elem483);
          }
        }
        struct.setTableStatsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.table_verbos_stats = new java.util.ArrayList<TTableIndexQueryStats>(_list485.size);
          @org.apache.thrift.annotation.Nullable TTableIndexQueryStats _elem486;
          for (int _i487 = 0; _i487 < _list485.size; ++_i487)
          {
            _elem486 = new TTableIndexQueryStats();
            _elem486.read(iprot);
            struct.table_verbos_stats.add(_elem486);
          }
        }
        struct.setTableVerbosStatsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TMap _map488 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I64); 
          struct.tablet_stats = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map488.size);
          long _key489;
          long _val490;
          for (int _i491 = 0; _i491 < _map488.size; ++_i491)
          {
            ...
            struct.tablet_stats.put(_key489, _val490);
          }
        }
        struct.setTabletStatsIsSet(true);
      }
