            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.lang.String>(_list114.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_desc = new java.util.ArrayList<TColumn>(_list117.size);
                @org.apache.thrift.annotation.Nullable TColumn _elem118;
                for (int _i119 = 0; _i119 < _list117.size; ++_i119)
                {
                  _elem118 = new TColumn();
                  _elem118.read(iprot);
                  struct.columns_desc.add(_elem118);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes_desc = new java.util.ArrayList<TOlapTableIndex>(_list120.size);
                @org.apache.thrift.annotation.Nullable TOlapTableIndex _elem121;
                for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                {
                  _elem121 = new TOlapTableIndex();
                  _elem121.read(iprot);
                  struct.indexes_desc.add(_elem121);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTableIndexSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter123 : struct.columns)
          {
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumnsDesc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (TColumn _iter124 : struct.columns_desc)
            {
      ...
      if (struct.indexes_desc != null) {
        if (struct.isSetIndexesDesc()) {
          oprot.writeFieldBegin(INDEXES_DESC_FIELD_DESC);
          {
            ...
            for (TOlapTableIndex _iter125 : struct.indexes_desc)
            {
  ...
  private static class TOlapTableIndexSchemaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableIndexSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableIndexSchema struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.id);
      {
        ...
        for (java.lang.String _iter126 : struct.columns)
        {
      ...
      if (struct.isSetColumnsDesc()) {
        {
          ...
          for (TColumn _iter127 : struct.columns_desc)
          {
      ...
      if (struct.isSetIndexesDesc()) {
        {
          ...
          for (TOlapTableIndex _iter128 : struct.indexes_desc)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableIndexSchema struct) throws org.apache.thrift.TException {
      ...
      struct.setIdIsSet(true);
      {
        ...
        struct.columns = new java.util.ArrayList<java.lang.String>(_list129.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columns_desc = new java.util.ArrayList<TColumn>(_list132.size);
          @org.apache.thrift.annotation.Nullable TColumn _elem133;
          for (int _i134 = 0; _i134 < _list132.size; ++_i134)
          {
            _elem133 = new TColumn();
            _elem133.read(iprot);
            struct.columns_desc.add(_elem133);
          }
        }
        struct.setColumnsDescIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.indexes_desc = new java.util.ArrayList<TOlapTableIndex>(_list135.size);
          @org.apache.thrift.annotation.Nullable TOlapTableIndex _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = new TOlapTableIndex();
            _elem136.read(iprot);
            struct.indexes_desc.add(_elem136);
          }
        }
        struct.setIndexesDescIsSet(true);
      }
