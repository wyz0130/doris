...
public class TAssertNumRowsNode implements org.apache.thrift.TBase<TAssertNumRowsNode, TAssertNumRowsNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAssertNumRowsNode> {
  ...
  private static final org.apache.thrift.protocol.TField SHOULD_CONVERT_OUTPUT_TO_NULLABLE_FIELD_DESC = new org.apache.thrift.protocol.TField("should_convert_output_to_nullable", org.apache.thrift.protocol.TType.BOOL, (short)4);
  ...
  public boolean should_convert_output_to_nullable; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SHOULD_CONVERT_OUTPUT_TO_NULLABLE((short)4, "should_convert_output_to_nullable");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // ASSERTION
          return ASSERTION;
        case 4: // SHOULD_CONVERT_OUTPUT_TO_NULLABLE
          return SHOULD_CONVERT_OUTPUT_TO_NULLABLE;
        default:
          return null;
      }
    }
  ...
  private static final int __SHOULD_CONVERT_OUTPUT_TO_NULLABLE_ISSET_ID = 1;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.DESIRED_NUM_ROWS,_Fields.SUBQUERY_STRING,_Fields.ASSERTION,_Fields.SHOULD_CONVERT_OUTPUT_TO_NULLABLE};
  ...
  static {
    ...
    tmpMap.put(_Fields.SHOULD_CONVERT_OUTPUT_TO_NULLABLE, new org.apache.thrift.meta_data.FieldMetaData("should_convert_output_to_nullable", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TAssertNumRowsNode(TAssertNumRowsNode other) {
    ...
    this.should_convert_output_to_nullable = other.should_convert_output_to_nullable;
  }
  ...
  public void clear() {
    ...
    this.assertion = null;
    setShouldConvertOutputToNullableIsSet(false);
    this.should_convert_output_to_nullable = false;
  }
  ...
  public boolean isShouldConvertOutputToNullable() {
    return this.should_convert_output_to_nullable;
  }

  public TAssertNumRowsNode setShouldConvertOutputToNullable(boolean should_convert_output_to_nullable) {
    this.should_convert_output_to_nullable = should_convert_output_to_nullable;
    setShouldConvertOutputToNullableIsSet(true);
    return this;
  }

  public void unsetShouldConvertOutputToNullable() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SHOULD_CONVERT_OUTPUT_TO_NULLABLE_ISSET_ID);
  }

  /** Returns true if field should_convert_output_to_nullable is set (has been assigned a value) and false otherwise */
  public boolean isSetShouldConvertOutputToNullable() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SHOULD_CONVERT_OUTPUT_TO_NULLABLE_ISSET_ID);
  }

  public void setShouldConvertOutputToNullableIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SHOULD_CONVERT_OUTPUT_TO_NULLABLE_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SHOULD_CONVERT_OUTPUT_TO_NULLABLE:
      if (value == null) {
        unsetShouldConvertOutputToNullable();
      } else {
        setShouldConvertOutputToNullable((java.lang.Boolean)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case SHOULD_CONVERT_OUTPUT_TO_NULLABLE:
      return isShouldConvertOutputToNullable();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SHOULD_CONVERT_OUTPUT_TO_NULLABLE:
      return isSetShouldConvertOutputToNullable();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(TAssertNumRowsNode that) {
    ...
    boolean this_present_should_convert_output_to_nullable = true && this.isSetShouldConvertOutputToNullable();
    boolean that_present_should_convert_output_to_nullable = true && that.isSetShouldConvertOutputToNullable();
    if (this_present_should_convert_output_to_nullable || that_present_should_convert_output_to_nullable) {
      if (!(this_present_should_convert_output_to_nullable && that_present_should_convert_output_to_nullable))
        return false;
      if (this.should_convert_output_to_nullable != that.should_convert_output_to_nullable)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetShouldConvertOutputToNullable()) ? 131071 : 524287);
    if (isSetShouldConvertOutputToNullable())
      hashCode = hashCode * 8191 + ((should_convert_output_to_nullable) ? 131071 : 524287);
  ...
  public int compareTo(TAssertNumRowsNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetShouldConvertOutputToNullable(), other.isSetShouldConvertOutputToNullable());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetShouldConvertOutputToNullable()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.should_convert_output_to_nullable, other.should_convert_output_to_nullable);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetShouldConvertOutputToNullable()) {
      if (!first) sb.append(", ");
      sb.append("should_convert_output_to_nullable:");
      sb.append(this.should_convert_output_to_nullable);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class TAssertNumRowsNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TAssertNumRowsNode> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // SHOULD_CONVERT_OUTPUT_TO_NULLABLE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.should_convert_output_to_nullable = iprot.readBool();
              struct.setShouldConvertOutputToNullableIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAssertNumRowsNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetShouldConvertOutputToNullable()) {
        oprot.writeFieldBegin(SHOULD_CONVERT_OUTPUT_TO_NULLABLE_FIELD_DESC);
        oprot.writeBool(struct.should_convert_output_to_nullable);
        oprot.writeFieldEnd();
      }
