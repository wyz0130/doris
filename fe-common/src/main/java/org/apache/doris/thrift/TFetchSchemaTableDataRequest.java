...
public class TFetchSchemaTableDataRequest implements org.apache.thrift.TBase<TFetchSchemaTableDataRequest, TFetchSchemaTableDataRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TFetchSchemaTableDataRequest> {
  ...
  private static final org.apache.thrift.protocol.TField SCHEMA_TABLE_PARAMS_FIELD_DESC = new org.apache.thrift.protocol.TField("schema_table_params", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable TSchemaTableRequestParams schema_table_params; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SCHEMA_TABLE_PARAMS((short)4, "schema_table_params");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 4: // SCHEMA_TABLE_PARAMS
          return SCHEMA_TABLE_PARAMS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER_NAME,_Fields.SCHEMA_TABLE_NAME,_Fields.METADA_TABLE_PARAMS,_Fields.SCHEMA_TABLE_PARAMS};
  ...
  static {
    ...
    tmpMap.put(_Fields.SCHEMA_TABLE_PARAMS, new org.apache.thrift.meta_data.FieldMetaData("schema_table_params", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TSchemaTableRequestParams.class)));
  ...
  public TFetchSchemaTableDataRequest(TFetchSchemaTableDataRequest other) {
    ...
    if (other.isSetSchemaTableParams()) {
      this.schema_table_params = new TSchemaTableRequestParams(other.schema_table_params);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TSchemaTableRequestParams getSchemaTableParams() {
    return this.schema_table_params;
  }

  public TFetchSchemaTableDataRequest setSchemaTableParams(@org.apache.thrift.annotation.Nullable TSchemaTableRequestParams schema_table_params) {
    this.schema_table_params = schema_table_params;
    return this;
  }

  public void unsetSchemaTableParams() {
    this.schema_table_params = null;
  }

  /** Returns true if field schema_table_params is set (has been assigned a value) and false otherwise */
  public boolean isSetSchemaTableParams() {
    return this.schema_table_params != null;
  }

  public void setSchemaTableParamsIsSet(boolean value) {
    if (!value) {
      this.schema_table_params = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SCHEMA_TABLE_PARAMS:
      if (value == null) {
        unsetSchemaTableParams();
      } else {
        setSchemaTableParams((TSchemaTableRequestParams)value);
      }
      break;
  ...
  public boolean equals(TFetchSchemaTableDataRequest that) {
    ...
    boolean this_present_schema_table_params = true && this.isSetSchemaTableParams();
    boolean that_present_schema_table_params = true && that.isSetSchemaTableParams();
    if (this_present_schema_table_params || that_present_schema_table_params) {
      if (!(this_present_schema_table_params && that_present_schema_table_params))
        return false;
      if (!this.schema_table_params.equals(that.schema_table_params))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSchemaTableParams()) ? 131071 : 524287);
    if (isSetSchemaTableParams())
      hashCode = hashCode * 8191 + schema_table_params.hashCode();
  ...
  public int compareTo(TFetchSchemaTableDataRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSchemaTableParams(), other.isSetSchemaTableParams());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSchemaTableParams()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.schema_table_params, other.schema_table_params);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetSchemaTableParams()) {
      if (!first) sb.append(", ");
      sb.append("schema_table_params:");
      if (this.schema_table_params == null) {
        sb.append("null");
      } else {
        sb.append(this.schema_table_params);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (schema_table_params != null) {
      schema_table_params.validate();
    }
  }
  ...
  private static class TFetchSchemaTableDataRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFetchSchemaTableDataRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TFetchSchemaTableDataRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // SCHEMA_TABLE_PARAMS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.schema_table_params = new TSchemaTableRequestParams();
              struct.schema_table_params.read(iprot);
              struct.setSchemaTableParamsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFetchSchemaTableDataRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.schema_table_params != null) {
        if (struct.isSetSchemaTableParams()) {
          oprot.writeFieldBegin(SCHEMA_TABLE_PARAMS_FIELD_DESC);
          struct.schema_table_params.write(oprot);
          oprot.writeFieldEnd();
        }
      }
