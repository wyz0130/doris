            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list310.size);
                long _elem311;
                for (int _i312 = 0; _i312 < _list310.size; ++_i312)
                {
                  _elem311 = iprot.readI64();
                  struct.table_ids.add(_elem311);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_ids != null) {
        if (struct.isSetTableIds()) {
          oprot.writeFieldBegin(TABLE_IDS_FIELD_DESC);
          {
            ...
            for (long _iter313 : struct.table_ids)
            {
      ...
      if (struct.isSetTableIds()) {
        {
          ...
          for (long _iter314 : struct.table_ids)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list315.size);
          long _elem316;
          for (int _i317 = 0; _i317 < _list315.size; ++_i317)
          {
            _elem316 = iprot.readI64();
            struct.table_ids.add(_elem316);
          }
        }
        struct.setTableIdsIsSet(true);
      }
