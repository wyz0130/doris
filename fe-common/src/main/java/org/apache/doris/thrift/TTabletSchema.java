...
public class TTabletSchema implements org.apache.thrift.TBase<TTabletSchema, TTabletSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TTabletSchema> {
  ...
  private static final org.apache.thrift.protocol.TField CLUSTER_KEY_IDXES_FIELD_DESC = new org.apache.thrift.protocol.TField("cluster_key_idxes", org.apache.thrift.protocol.TType.LIST, (short)19);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> cluster_key_idxes; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CLUSTER_KEY_IDXES((short)19, "cluster_key_idxes");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 19: // CLUSTER_KEY_IDXES
          return CLUSTER_KEY_IDXES;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.SKIP_WRITE_INDEX_ON_LOAD, new org.apache.thrift.meta_data.FieldMetaData("skip_write_index_on_load", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.CLUSTER_KEY_IDXES, new org.apache.thrift.meta_data.FieldMetaData("cluster_key_idxes", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32))));
  ...
  public TTabletSchema(TTabletSchema other) {
    ...
    if (other.isSetClusterKeyIdxes()) {
      java.util.List<java.lang.Integer> __this__cluster_key_idxes = new java.util.ArrayList<java.lang.Integer>(other.cluster_key_idxes);
      this.cluster_key_idxes = __this__cluster_key_idxes;
    }
  }
  ...
  public int getClusterKeyIdxesSize() {
    return (this.cluster_key_idxes == null) ? 0 : this.cluster_key_idxes.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Integer> getClusterKeyIdxesIterator() {
    return (this.cluster_key_idxes == null) ? null : this.cluster_key_idxes.iterator();
  }

  public void addToClusterKeyIdxes(int elem) {
    if (this.cluster_key_idxes == null) {
      this.cluster_key_idxes = new java.util.ArrayList<java.lang.Integer>();
    }
    this.cluster_key_idxes.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Integer> getClusterKeyIdxes() {
    return this.cluster_key_idxes;
  }

  public TTabletSchema setClusterKeyIdxes(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> cluster_key_idxes) {
    this.cluster_key_idxes = cluster_key_idxes;
    return this;
  }

  public void unsetClusterKeyIdxes() {
    this.cluster_key_idxes = null;
  }

  /** Returns true if field cluster_key_idxes is set (has been assigned a value) and false otherwise */
  public boolean isSetClusterKeyIdxes() {
    return this.cluster_key_idxes != null;
  }

  public void setClusterKeyIdxesIsSet(boolean value) {
    if (!value) {
      this.cluster_key_idxes = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CLUSTER_KEY_IDXES:
      if (value == null) {
        unsetClusterKeyIdxes();
      } else {
        setClusterKeyIdxes((java.util.List<java.lang.Integer>)value);
      }
      break;
  ...
  public boolean equals(TTabletSchema that) {
    ...
    boolean this_present_cluster_key_idxes = true && this.isSetClusterKeyIdxes();
    boolean that_present_cluster_key_idxes = true && that.isSetClusterKeyIdxes();
    if (this_present_cluster_key_idxes || that_present_cluster_key_idxes) {
      if (!(this_present_cluster_key_idxes && that_present_cluster_key_idxes))
        return false;
      if (!this.cluster_key_idxes.equals(that.cluster_key_idxes))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetClusterKeyIdxes()) ? 131071 : 524287);
    if (isSetClusterKeyIdxes())
      hashCode = hashCode * 8191 + cluster_key_idxes.hashCode();
  ...
  public int compareTo(TTabletSchema other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetClusterKeyIdxes(), other.isSetClusterKeyIdxes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClusterKeyIdxes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cluster_key_idxes, other.cluster_key_idxes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetClusterKeyIdxes()) {
      if (!first) sb.append(", ");
      sb.append("cluster_key_idxes:");
      if (this.cluster_key_idxes == null) {
        sb.append("null");
      } else {
        sb.append(this.cluster_key_idxes);
      }
      first = false;
    }
    sb.append(")");
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cluster_key_idxes = new java.util.ArrayList<java.lang.Integer>(_list6.size);
                int _elem7;
                for (int _i8 = 0; _i8 < _list6.size; ++_i8)
                {
                  _elem7 = iprot.readI32();
                  struct.cluster_key_idxes.add(_elem7);
                }
                iprot.readListEnd();
              }
              struct.setClusterKeyIdxesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter9 : struct.columns)
          {
            _iter9.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.indexes != null) {
        if (struct.isSetIndexes()) {
          oprot.writeFieldBegin(INDEXES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTableIndex _iter10 : struct.indexes)
            {
              _iter10.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.cluster_key_idxes != null) {
        if (struct.isSetClusterKeyIdxes()) {
          oprot.writeFieldBegin(CLUSTER_KEY_IDXES_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.cluster_key_idxes.size()));
            for (int _iter11 : struct.cluster_key_idxes)
            {
  ...
  private static class TTabletSchemaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTabletSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetClusterKeyIdxes()) {
        {
          oprot.writeI32(struct.cluster_key_idxes.size());
          for (int _iter14 : struct.cluster_key_idxes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      struct.setStorageTypeIsSet(true);
      {
        ...
        struct.columns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list15.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem16;
        for (int _i17 = 0; _i17 < _list15.size; ++_i17)
        {
          _elem16 = new org.apache.doris.thrift.TColumn();
          _elem16.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.indexes = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list18.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new org.apache.doris.thrift.TOlapTableIndex();
            _elem19.read(iprot);
            struct.indexes.add(_elem19);
          }
        }
        struct.setIndexesIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.cluster_key_idxes = new java.util.ArrayList<java.lang.Integer>(_list21.size);
          int _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readI32();
            struct.cluster_key_idxes.add(_elem22);
          }
        }
        struct.setClusterKeyIdxesIsSet(true);
      }
