...
public class TTableRef implements org.apache.thrift.TBase<TTableRef, TTableRef._Fields>, java.io.Serializable, Cloneable, Comparable<TTableRef> {
  ...
  private static final org.apache.thrift.protocol.TField ALIAS_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("alias_name", org.apache.thrift.protocol.TType.STRING, (short)3);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String alias_name; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    TABLE((short)1, "table"),
    ALIAS_NAME((short)3, "alias_name");
  ...
  private static final _Fields optionals[] = {_Fields.TABLE,_Fields.ALIAS_NAME};
  ...
  static {
    ...
    tmpMap.put(_Fields.ALIAS_NAME, new org.apache.thrift.meta_data.FieldMetaData("alias_name", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public TTableRef setAliasName(@org.apache.thrift.annotation.Nullable java.lang.String alias_name) {
  ...
  /** Returns true if field alias_name is set (has been assigned a value) and false otherwise */
  ...
  public boolean equals(TTableRef that) {
    ...
    boolean this_present_alias_name = true && this.isSetAliasName();
    boolean that_present_alias_name = true && that.isSetAliasName();
    if (this_present_alias_name || that_present_alias_name) {
      if (!(this_present_alias_name && that_present_alias_name))
        return false;
      if (!this.alias_name.equals(that.alias_name))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetAliasName())
      hashCode = hashCode * 8191 + alias_name.hashCode();
  ...
  public int compareTo(TTableRef other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAliasName(), other.isSetAliasName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAliasName()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.alias_name, other.alias_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TTableRef struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // ALIAS_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.alias_name = iprot.readString();
