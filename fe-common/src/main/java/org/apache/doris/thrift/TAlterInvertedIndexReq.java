            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.alter_inverted_indexes = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list64.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new org.apache.doris.thrift.TOlapTableIndex();
                  _elem65.read(iprot);
                  struct.alter_inverted_indexes.add(_elem65);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes_desc = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list67.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem68;
                for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                {
                  _elem68 = new org.apache.doris.thrift.TOlapTableIndex();
                  _elem68.read(iprot);
                  struct.indexes_desc.add(_elem68);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list70.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem71;
                for (int _i72 = 0; _i72 < _list70.size; ++_i72)
                {
                  _elem71 = new org.apache.doris.thrift.TColumn();
                  _elem71.read(iprot);
      ...
      if (struct.alter_inverted_indexes != null) {
        if (struct.isSetAlterInvertedIndexes()) {
          oprot.writeFieldBegin(ALTER_INVERTED_INDEXES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTableIndex _iter73 : struct.alter_inverted_indexes)
            {
              _iter73.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.indexes_desc != null) {
        if (struct.isSetIndexesDesc()) {
          oprot.writeFieldBegin(INDEXES_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTableIndex _iter74 : struct.indexes_desc)
            {
              _iter74.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter75 : struct.columns)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAlterInvertedIndexes()) {
        {
          ...
          for (org.apache.doris.thrift.TOlapTableIndex _iter76 : struct.alter_inverted_indexes)
          {
            _iter76.write(oprot);
          }
        }
      ...
      if (struct.isSetIndexesDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TOlapTableIndex _iter77 : struct.indexes_desc)
          {
            _iter77.write(oprot);
          }
        }
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter78 : struct.columns)
          {
            _iter78.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.alter_inverted_indexes = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list79.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new org.apache.doris.thrift.TOlapTableIndex();
            _elem80.read(iprot);
            struct.alter_inverted_indexes.add(_elem80);
          }
        }
        struct.setAlterInvertedIndexesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.indexes_desc = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list82.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem83;
          for (int _i84 = 0; _i84 < _list82.size; ++_i84)
          {
            _elem83 = new org.apache.doris.thrift.TOlapTableIndex();
            _elem83.read(iprot);
            struct.indexes_desc.add(_elem83);
          }
        }
        struct.setIndexesDescIsSet(true);
      }
