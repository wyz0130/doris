...
public class TExchangeNode implements org.apache.thrift.TBase<TExchangeNode, TExchangeNode._Fields>, java.io.Serializable, Cloneable, Comparable<TExchangeNode> {
  ...
  private static final _Fields optionals[] = {_Fields.SORT_INFO,_Fields.OFFSET,_Fields.PARTITION_TYPE};
   ...
   * @see org.apache.doris.thrift.TPartitionType
   */
  public TExchangeNode setPartitionType(@org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPartitionType partition_type) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.input_row_tuples = new java.util.ArrayList<java.lang.Integer>(_list868.size);
                int _elem869;
                for (int _i870 = 0; _i870 < _list868.size; ++_i870)
                {
                  _elem869 = iprot.readI32();
                  struct.input_row_tuples.add(_elem869);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExchangeNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.input_row_tuples != null) {
        oprot.writeFieldBegin(INPUT_ROW_TUPLES_FIELD_DESC);
        {
          ...
          for (int _iter871 : struct.input_row_tuples)
          {
            oprot.writeI32(_iter871);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TExchangeNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExchangeNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExchangeNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (int _iter872 : struct.input_row_tuples)
        {
          oprot.writeI32(_iter872);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExchangeNode struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list873 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.input_row_tuples = new java.util.ArrayList<java.lang.Integer>(_list873.size);
        int _elem874;
        for (int _i875 = 0; _i875 < _list873.size; ++_i875)
        {
          _elem874 = iprot.readI32();
          struct.input_row_tuples.add(_elem874);
        }
      }
      struct.setInputRowTuplesIsSet(true);
