            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map120.size);
                ...
                for (int _i123 = 0; _i123 < _map120.size; ++_i123)
                {
                  ...
                  struct.src_dest_map.put(_key121, _val122);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map124.size);
                ...
                for (int _i127 = 0; _i127 < _map124.size; ++_i127)
                {
                  ...
                  struct.broker_prop.put(_key125, _val126);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter128 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBrokerProp()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter129 : struct.broker_prop.entrySet())
            {
  ...
  private static class TUploadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUploadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUploadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter130 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBrokerProp()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter131 : struct.broker_prop.entrySet())
          {
