      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list918.size);
                int _elem919;
                for (int _i920 = 0; _i920 < _list918.size; ++_i920)
                {
                  _elem919 = iprot.readI32();
                  struct.row_tuples.add(_elem919);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list921.size);
                boolean _elem922;
                for (int _i923 = 0; _i923 < _list921.size; ++_i923)
                {
                  _elem922 = iprot.readBool();
                  struct.nullable_tuples.add(_elem922);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list924.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem925;
                for (int _i926 = 0; _i926 < _list924.size; ++_i926)
                {
                  _elem925 = new org.apache.doris.thrift.TExpr();
                  _elem925.read(iprot);
                  struct.conjuncts.add(_elem925);
                }
                iprot.readListEnd();
              }
          ...
          case 36: // RUNTIME_FILTERS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                org.apache.thrift.protocol.TList _list927 = iprot.readListBegin();
                struct.runtime_filters = new java.util.ArrayList<TRuntimeFilterDesc>(_list927.size);
                @org.apache.thrift.annotation.Nullable TRuntimeFilterDesc _elem928;
                for (int _i929 = 0; _i929 < _list927.size; ++_i929)
                {
                  _elem928 = new TRuntimeFilterDesc();
                  _elem928.read(iprot);
                  struct.runtime_filters.add(_elem928);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list930.size);
                int _elem931;
                for (int _i932 = 0; _i932 < _list930.size; ++_i932)
                {
                  _elem931 = iprot.readI32();
                  struct.output_slot_ids.add(_elem931);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.distribute_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list933.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem934;
                for (int _i935 = 0; _i935 < _list933.size; ++_i935)
                {
                  {
                    org.apache.thrift.protocol.TList _list936 = iprot.readListBegin();
                    _elem934 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list936.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem937;
                    for (int _i938 = 0; _i938 < _list936.size; ++_i938)
                    {
                      _elem937 = new org.apache.doris.thrift.TExpr();
                      _elem937.read(iprot);
                      _elem934.add(_elem937);
                    }
                    iprot.readListEnd();
                  }
                  struct.distribute_expr_lists.add(_elem934);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_projections_list = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list942.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem943;
                for (int _i944 = 0; _i944 < _list942.size; ++_i944)
                {
                  {
                    org.apache.thrift.protocol.TList _list945 = iprot.readListBegin();
                    _elem943 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list945.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem946;
                    for (int _i947 = 0; _i947 < _list945.size; ++_i947)
                    {
                      _elem946 = new org.apache.doris.thrift.TExpr();
                      _elem946.read(iprot);
                      _elem943.add(_elem946);
                    }
                    iprot.readListEnd();
                  }
                  struct.intermediate_projections_list.add(_elem943);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_output_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list948.size);
                int _elem949;
                for (int _i950 = 0; _i950 < _list948.size; ++_i950)
                {
                  _elem949 = iprot.readI32();
                  struct.intermediate_output_tuple_id_list.add(_elem949);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.row_tuples != null) {
        oprot.writeFieldBegin(ROW_TUPLES_FIELD_DESC);
        {
          ...
          for (int _iter951 : struct.row_tuples)
          {
            oprot.writeI32(_iter951);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.nullable_tuples != null) {
        oprot.writeFieldBegin(NULLABLE_TUPLES_FIELD_DESC);
        {
          ...
          for (boolean _iter952 : struct.nullable_tuples)
          {
            oprot.writeBool(_iter952);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.conjuncts != null) {
        if (struct.isSetConjuncts()) {
          oprot.writeFieldBegin(CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter953 : struct.conjuncts)
            {
      ...
      if (struct.runtime_filters != null) {
        if (struct.isSetRuntimeFilters()) {
          oprot.writeFieldBegin(RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (TRuntimeFilterDesc _iter954 : struct.runtime_filters)
            {
      ...
      if (struct.output_slot_ids != null) {
        if (struct.isSetOutputSlotIds()) {
          oprot.writeFieldBegin(OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter955 : struct.output_slot_ids)
            {
              oprot.writeI32(_iter955);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.distribute_expr_lists != null) {
        if (struct.isSetDistributeExprLists()) {
          oprot.writeFieldBegin(DISTRIBUTE_EXPR_LISTS_FIELD_DESC);
          {
            ...
            for (java.util.List<org.apache.doris.thrift.TExpr> _iter956 : struct.distribute_expr_lists)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter956.size()));
                for (org.apache.doris.thrift.TExpr _iter957 : _iter956)
                {
      ...
      if (struct.projections != null) {
        if (struct.isSetProjections()) {
          oprot.writeFieldBegin(PROJECTIONS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter958 : struct.projections)
            {
      ...
      if (struct.intermediate_projections_list != null) {
        if (struct.isSetIntermediateProjectionsList()) {
          oprot.writeFieldBegin(INTERMEDIATE_PROJECTIONS_LIST_FIELD_DESC);
          {
            ...
            for (java.util.List<org.apache.doris.thrift.TExpr> _iter959 : struct.intermediate_projections_list)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter959.size()));
                for (org.apache.doris.thrift.TExpr _iter960 : _iter959)
                {
      ...
      if (struct.intermediate_output_tuple_id_list != null) {
        if (struct.isSetIntermediateOutputTupleIdList()) {
          oprot.writeFieldBegin(INTERMEDIATE_OUTPUT_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter961 : struct.intermediate_output_tuple_id_list)
            {
  ...
  private static class TPlanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPlanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.limit);
      {
        ...
        for (int _iter962 : struct.row_tuples)
        {
          oprot.writeI32(_iter962);
        }
      }
      {
        oprot.writeI32(struct.nullable_tuples.size());
        for (boolean _iter963 : struct.nullable_tuples)
        {
          oprot.writeBool(_iter963);
        }
      }
      oprot.writeBool(struct.compact_data);
      ...
      if (struct.isSetConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter964 : struct.conjuncts)
          {
      ...
      if (struct.isSetRuntimeFilters()) {
        {
          ...
          for (TRuntimeFilterDesc _iter965 : struct.runtime_filters)
          {
      ...
      if (struct.isSetOutputSlotIds()) {
        {
          ...
          for (int _iter966 : struct.output_slot_ids)
          {
            oprot.writeI32(_iter966);
          }
        }
      }
      if (struct.isSetDataGenScanNode()) {
      ...
      if (struct.isSetDistributeExprLists()) {
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter967 : struct.distribute_expr_lists)
          {
            {
              oprot.writeI32(_iter967.size());
              for (org.apache.doris.thrift.TExpr _iter968 : _iter967)
              {
      ...
      if (struct.isSetProjections()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter969 : struct.projections)
          {
      ...
      if (struct.isSetIntermediateProjectionsList()) {
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter970 : struct.intermediate_projections_list)
          {
            {
              oprot.writeI32(_iter970.size());
              for (org.apache.doris.thrift.TExpr _iter971 : _iter970)
              {
      ...
      if (struct.isSetIntermediateOutputTupleIdList()) {
        {
          ...
          for (int _iter972 : struct.intermediate_output_tuple_id_list)
          {
            oprot.writeI32(_iter972);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setLimitIsSet(true);
      {
        org.apache.thrift.protocol.TList _list973 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.row_tuples = new java.util.ArrayList<java.lang.Integer>(_list973.size);
        int _elem974;
        for (int _i975 = 0; _i975 < _list973.size; ++_i975)
        {
          _elem974 = iprot.readI32();
          struct.row_tuples.add(_elem974);
        }
      }
      struct.setRowTuplesIsSet(true);
      {
        org.apache.thrift.protocol.TList _list976 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
        struct.nullable_tuples = new java.util.ArrayList<java.lang.Boolean>(_list976.size);
        boolean _elem977;
        for (int _i978 = 0; _i978 < _list976.size; ++_i978)
        {
          _elem977 = iprot.readBool();
          struct.nullable_tuples.add(_elem977);
        }
      }
      struct.setNullableTuplesIsSet(true);
      struct.compact_data = iprot.readBool();
      struct.setCompactDataIsSet(true);
      java.util.BitSet incoming = iprot.readBitSet(42);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list979 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list979.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem980;
          for (int _i981 = 0; _i981 < _list979.size; ++_i981)
          {
            _elem980 = new org.apache.doris.thrift.TExpr();
            _elem980.read(iprot);
            struct.conjuncts.add(_elem980);
          }
        }
        struct.setConjunctsIsSet(true);
      }
      ...
      if (incoming.get(24)) {
        {
          org.apache.thrift.protocol.TList _list982 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.runtime_filters = new java.util.ArrayList<TRuntimeFilterDesc>(_list982.size);
          @org.apache.thrift.annotation.Nullable TRuntimeFilterDesc _elem983;
          for (int _i984 = 0; _i984 < _list982.size; ++_i984)
          {
            _elem983 = new TRuntimeFilterDesc();
            _elem983.read(iprot);
            struct.runtime_filters.add(_elem983);
          }
        }
        struct.setRuntimeFiltersIsSet(true);
      }
      ...
      if (incoming.get(28)) {
        {
          org.apache.thrift.protocol.TList _list985 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list985.size);
          int _elem986;
          for (int _i987 = 0; _i987 < _list985.size; ++_i987)
          {
            _elem986 = iprot.readI32();
            struct.output_slot_ids.add(_elem986);
          }
        }
        struct.setOutputSlotIdsIsSet(true);
      }
      ...
      if (incoming.get(36)) {
        {
          org.apache.thrift.protocol.TList _list988 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
          struct.distribute_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list988.size);
          @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem989;
          ...
          {
            {
              ...
              _elem989 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list991.size);
              @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem992;
              for (int _i993 = 0; _i993 < _list991.size; ++_i993)
              {
                _elem992 = new org.apache.doris.thrift.TExpr();
                _elem992.read(iprot);
                _elem989.add(_elem992);
              }
            }
            struct.distribute_expr_lists.add(_elem989);
          }
        }
        struct.setDistributeExprListsIsSet(true);
      }
      if (incoming.get(37)) {
        {
          org.apache.thrift.protocol.TList _list994 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.projections = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list994.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem995;
          for (int _i996 = 0; _i996 < _list994.size; ++_i996)
          {
            _elem995 = new org.apache.doris.thrift.TExpr();
            _elem995.read(iprot);
            struct.projections.add(_elem995);
          }
        }
        struct.setProjectionsIsSet(true);
      }
      ...
      if (incoming.get(40)) {
        {
          org.apache.thrift.protocol.TList _list997 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
          struct.intermediate_projections_list = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list997.size);
          @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem998;
          for (int _i999 = 0; _i999 < _list997.size; ++_i999)
          {
            {
              org.apache.thrift.protocol.TList _list1000 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
              _elem998 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list1000.size);
              @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem1001;
              for (int _i1002 = 0; _i1002 < _list1000.size; ++_i1002)
              {
                _elem1001 = new org.apache.doris.thrift.TExpr();
                _elem1001.read(iprot);
                _elem998.add(_elem1001);
              }
            }
            struct.intermediate_projections_list.add(_elem998);
          }
        }
        struct.setIntermediateProjectionsListIsSet(true);
      }
      if (incoming.get(41)) {
        {
          org.apache.thrift.protocol.TList _list1003 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.intermediate_output_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list1003.size);
          int _elem1004;
          for (int _i1005 = 0; _i1005 < _list1003.size; ++_i1005)
          {
            _elem1004 = iprot.readI32();
            struct.intermediate_output_tuple_id_list.add(_elem1004);
          }
        }
        struct.setIntermediateOutputTupleIdListIsSet(true);
      }
