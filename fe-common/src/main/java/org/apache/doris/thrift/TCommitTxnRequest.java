            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commit_infos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list368.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem369;
                for (int _i370 = 0; _i370 < _list368.size; ++_i370)
                {
                  _elem369 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem369.read(iprot);
                  struct.commit_infos.add(_elem369);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.commit_infos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter371 : struct.commit_infos)
            {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter372 : struct.commit_infos)
          {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.commit_infos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list373.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem374;
          for (int _i375 = 0; _i375 < _list373.size; ++_i375)
          {
            _elem374 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem374.read(iprot);
            struct.commit_infos.add(_elem374);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
