            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updates = new java.util.ArrayList<TTopicItem>(_list226.size);
                @org.apache.thrift.annotation.Nullable TTopicItem _elem227;
                for (int _i228 = 0; _i228 < _list226.size; ++_i228)
                {
                  _elem227 = new TTopicItem();
                  _elem227.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deletes = new java.util.ArrayList<java.lang.String>(_list229.size);
      ...
      if (struct.updates != null) {
        if (struct.isSetUpdates()) {
          oprot.writeFieldBegin(UPDATES_FIELD_DESC);
          {
            ...
            for (TTopicItem _iter232 : struct.updates)
            {
      ...
      if (struct.deletes != null) {
        if (struct.isSetDeletes()) {
          oprot.writeFieldBegin(DELETES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter233 : struct.deletes)
            {
      ...
      if (struct.isSetUpdates()) {
        {
          ...
          for (TTopicItem _iter234 : struct.updates)
          {
      ...
      if (struct.isSetDeletes()) {
        {
          ...
          for (java.lang.String _iter235 : struct.deletes)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.updates = new java.util.ArrayList<TTopicItem>(_list236.size);
          @org.apache.thrift.annotation.Nullable TTopicItem _elem237;
          for (int _i238 = 0; _i238 < _list236.size; ++_i238)
          {
            _elem237 = new TTopicItem();
            _elem237.read(iprot);
            struct.updates.add(_elem237);
          }
        }
        struct.setUpdatesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.deletes = new java.util.ArrayList<java.lang.String>(_list239.size);
