            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.group_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list692.size);
                ...
                for (int _i694 = 0; _i694 < _list692.size; ++_i694)
                {
                  ...
                  _elem693.read(iprot);
                  struct.group_exprs.add(_elem693);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list695.size);
                ...
                for (int _i697 = 0; _i697 < _list695.size; ++_i697)
                {
                  ...
                  _elem696.read(iprot);
                  struct.aggregate_exprs.add(_elem696);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPreAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.group_exprs != null) {
        oprot.writeFieldBegin(GROUP_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter698 : struct.group_exprs)
          {
      ...
      if (struct.aggregate_exprs != null) {
        oprot.writeFieldBegin(AGGREGATE_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter699 : struct.aggregate_exprs)
          {
  ...
  private static class TPreAggregationNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPreAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPreAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter700 : struct.group_exprs)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter701 : struct.aggregate_exprs)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPreAggregationNode struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list702 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.group_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list702.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem703;
        for (int _i704 = 0; _i704 < _list702.size; ++_i704)
        {
          _elem703 = new org.apache.doris.thrift.TExpr();
          _elem703.read(iprot);
          struct.group_exprs.add(_elem703);
        }
      }
      struct.setGroupExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list705 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.aggregate_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list705.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem706;
        for (int _i707 = 0; _i707 < _list705.size; ++_i707)
        {
          _elem706 = new org.apache.doris.thrift.TExpr();
          _elem706.read(iprot);
          struct.aggregate_exprs.add(_elem706);
        }
      }
      struct.setAggregateExprsIsSet(true);
    }
