        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slot_id_set_list = new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list636.size);
                @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> _elem637;
                for (int _i638 = 0; _i638 < _list636.size; ++_i638)
                {
                  {
                    org.apache.thrift.protocol.TSet _set639 = iprot.readSetBegin();
                    _elem637 = new java.util.HashSet<java.lang.Integer>(2*_set639.size);
                    int _elem640;
                    for (int _i641 = 0; _i641 < _set639.size; ++_i641)
                    {
                      _elem640 = iprot.readI32();
                      _elem637.add(_elem640);
                    }
                    iprot.readSetEnd();
                  }
                  struct.slot_id_set_list.add(_elem637);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.repeat_id_list = new java.util.ArrayList<java.lang.Long>(_list642.size);
                long _elem643;
                for (int _i644 = 0; _i644 < _list642.size; ++_i644)
                {
                  _elem643 = iprot.readI64();
                  struct.repeat_id_list.add(_elem643);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_list = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list645.size);
                @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem646;
                for (int _i647 = 0; _i647 < _list645.size; ++_i647)
                {
                  {
                    org.apache.thrift.protocol.TList _list648 = iprot.readListBegin();
                    _elem646 = new java.util.ArrayList<java.lang.Long>(_list648.size);
                    long _elem649;
                    for (int _i650 = 0; _i650 < _list648.size; ++_i650)
                    {
                      _elem649 = iprot.readI64();
                      _elem646.add(_elem649);
                    }
                    iprot.readListEnd();
                  }
                  struct.grouping_list.add(_elem646);
                }
                iprot.readListEnd();
              }
          ...
          case 5: // ALL_SLOT_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set651 = iprot.readSetBegin();
                struct.all_slot_ids = new java.util.HashSet<java.lang.Integer>(2*_set651.size);
                int _elem652;
                for (int _i653 = 0; _i653 < _set651.size; ++_i653)
                {
                  _elem652 = iprot.readI32();
                  struct.all_slot_ids.add(_elem652);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list654.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem655;
                for (int _i656 = 0; _i656 < _list654.size; ++_i656)
                {
                  _elem655 = new org.apache.doris.thrift.TExpr();
                  _elem655.read(iprot);
                  struct.exprs.add(_elem655);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.slot_id_set_list != null) {
        oprot.writeFieldBegin(SLOT_ID_SET_LIST_FIELD_DESC);
        {
          ...
          for (java.util.Set<java.lang.Integer> _iter657 : struct.slot_id_set_list)
          {
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, _iter657.size()));
              for (int _iter658 : _iter657)
              {
      ...
      if (struct.repeat_id_list != null) {
        oprot.writeFieldBegin(REPEAT_ID_LIST_FIELD_DESC);
        {
          ...
          for (long _iter659 : struct.repeat_id_list)
          {
      ...
      if (struct.grouping_list != null) {
        oprot.writeFieldBegin(GROUPING_LIST_FIELD_DESC);
        {
          ...
          for (java.util.List<java.lang.Long> _iter660 : struct.grouping_list)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, _iter660.size()));
              for (long _iter661 : _iter660)
              {
      ...
      if (struct.all_slot_ids != null) {
        oprot.writeFieldBegin(ALL_SLOT_IDS_FIELD_DESC);
        {
          ...
          for (int _iter662 : struct.all_slot_ids)
          {
            oprot.writeI32(_iter662);
          }
          oprot.writeSetEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.exprs != null) {
        oprot.writeFieldBegin(EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter663 : struct.exprs)
          {
  ...
  private static class TRepeatNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRepeatNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.output_tuple_id);
      {
        ...
        for (java.util.Set<java.lang.Integer> _iter664 : struct.slot_id_set_list)
        {
          {
            oprot.writeI32(_iter664.size());
            for (int _iter665 : _iter664)
            {
      ...
      }
      {
        ...
        for (long _iter666 : struct.repeat_id_list)
        {
      ...
      }
      {
        ...
        for (java.util.List<java.lang.Long> _iter667 : struct.grouping_list)
        {
          {
            oprot.writeI32(_iter667.size());
            for (long _iter668 : _iter667)
            {
      ...
      }
      {
        ...
        for (int _iter669 : struct.all_slot_ids)
        {
          oprot.writeI32(_iter669);
        }
      }
      {
        oprot.writeI32(struct.exprs.size());
        for (org.apache.doris.thrift.TExpr _iter670 : struct.exprs)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRepeatNode struct) throws org.apache.thrift.TException {
      ...
      struct.setOutputTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list671 = iprot.readListBegin(org.apache.thrift.protocol.TType.SET);
        struct.slot_id_set_list = new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list671.size);
        @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Integer> _elem672;
        for (int _i673 = 0; _i673 < _list671.size; ++_i673)
        {
          {
            org.apache.thrift.protocol.TSet _set674 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
            _elem672 = new java.util.HashSet<java.lang.Integer>(2*_set674.size);
            int _elem675;
            for (int _i676 = 0; _i676 < _set674.size; ++_i676)
            {
              _elem675 = iprot.readI32();
              _elem672.add(_elem675);
            }
          }
          struct.slot_id_set_list.add(_elem672);
        }
      }
      struct.setSlotIdSetListIsSet(true);
      {
        org.apache.thrift.protocol.TList _list677 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
        struct.repeat_id_list = new java.util.ArrayList<java.lang.Long>(_list677.size);
        long _elem678;
        for (int _i679 = 0; _i679 < _list677.size; ++_i679)
        {
          _elem678 = iprot.readI64();
          struct.repeat_id_list.add(_elem678);
        }
      }
      struct.setRepeatIdListIsSet(true);
      {
        org.apache.thrift.protocol.TList _list680 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.grouping_list = new java.util.ArrayList<java.util.List<java.lang.Long>>(_list680.size);
        @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> _elem681;
        for (int _i682 = 0; _i682 < _list680.size; ++_i682)
        {
          {
            org.apache.thrift.protocol.TList _list683 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
            _elem681 = new java.util.ArrayList<java.lang.Long>(_list683.size);
            long _elem684;
          ...
          struct.grouping_list.add(_elem681);
        }
      }
      struct.setGroupingListIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set686 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
        struct.all_slot_ids = new java.util.HashSet<java.lang.Integer>(2*_set686.size);
        int _elem687;
        for (int _i688 = 0; _i688 < _set686.size; ++_i688)
        {
          _elem687 = iprot.readI32();
          struct.all_slot_ids.add(_elem687);
        }
      }
      struct.setAllSlotIdsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list689 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list689.size);
