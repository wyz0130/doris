              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new java.util.ArrayList<org.apache.doris.thrift.TAgentTaskRequest>(_list114.size);
                  @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TAgentTaskRequest _elem115;
                  for (int _i116 = 0; _i116 < _list114.size; ++_i116)
                  {
                    _elem115 = new org.apache.doris.thrift.TAgentTaskRequest();
                    _elem115.read(iprot);
                    struct.tasks.add(_elem115);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, submit_tasks_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TAgentTaskRequest _iter117 : struct.tasks)
            {
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (org.apache.doris.thrift.TAgentTaskRequest _iter118 : struct.tasks)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new java.util.ArrayList<org.apache.doris.thrift.TAgentTaskRequest>(_list119.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TAgentTaskRequest _elem120;
            for (int _i121 = 0; _i121 < _list119.size; ++_i121)
            {
              _elem120 = new org.apache.doris.thrift.TAgentTaskRequest();
              _elem120.read(iprot);
              struct.tasks.add(_elem120);
            }
          }
          struct.setTasksIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<TDiskTrashInfo>(_list122.size);
                  @org.apache.thrift.annotation.Nullable TDiskTrashInfo _elem123;
                  for (int _i124 = 0; _i124 < _list122.size; ++_i124)
                  {
                    _elem123 = new TDiskTrashInfo();
                    _elem123.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, get_disk_trash_used_capacity_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (TDiskTrashInfo _iter125 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (TDiskTrashInfo _iter126 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<TDiskTrashInfo>(_list127.size);
            @org.apache.thrift.annotation.Nullable TDiskTrashInfo _elem128;
            for (int _i129 = 0; _i129 < _list127.size; ++_i129)
            {
              _elem128 = new TDiskTrashInfo();
              _elem128.read(iprot);
    ...
    private static class submit_routine_load_task_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<submit_routine_load_task_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new java.util.ArrayList<TRoutineLoadTask>(_list130.size);
                  @org.apache.thrift.annotation.Nullable TRoutineLoadTask _elem131;
                  for (int _i132 = 0; _i132 < _list130.size; ++_i132)
                  {
                    _elem131 = new TRoutineLoadTask();
                    _elem131.read(iprot);
                    struct.tasks.add(_elem131);
                  }
                  iprot.readListEnd();
                }
                struct.setTasksIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, submit_routine_load_task_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.tasks.size()));
            for (TRoutineLoadTask _iter133 : struct.tasks)
            {
    ...
    private static class submit_routine_load_task_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<submit_routine_load_task_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, submit_routine_load_task_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetTasks()) {
          {
            oprot.writeI32(struct.tasks.size());
            for (TRoutineLoadTask _iter134 : struct.tasks)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new java.util.ArrayList<TRoutineLoadTask>(_list135.size);
            @org.apache.thrift.annotation.Nullable TRoutineLoadTask _elem136;
            for (int _i137 = 0; _i137 < _list135.size; ++_i137)
            {
              _elem136 = new TRoutineLoadTask();
              _elem136.read(iprot);
              struct.tasks.add(_elem136);
            }
          }
          struct.setTasksIsSet(true);
        }
