            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list210.size);
                @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem211;
                for (int _i212 = 0; _i212 < _list210.size; ++_i212)
                {
                  _elem211 = new TTabletMetaInfo();
                  _elem211.read(iprot);
                  struct.tabletMetaInfos.add(_elem211);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tabletMetaInfos != null) {
        if (struct.isSetTabletMetaInfos()) {
          oprot.writeFieldBegin(TABLET_META_INFOS_FIELD_DESC);
          {
            ...
            for (TTabletMetaInfo _iter213 : struct.tabletMetaInfos)
            {
      ...
      if (struct.isSetTabletMetaInfos()) {
        {
          ...
          for (TTabletMetaInfo _iter214 : struct.tabletMetaInfos)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tabletMetaInfos = new java.util.ArrayList<TTabletMetaInfo>(_list215.size);
          @org.apache.thrift.annotation.Nullable TTabletMetaInfo _elem216;
          for (int _i217 = 0; _i217 < _list215.size; ++_i217)
          {
            _elem216 = new TTabletMetaInfo();
            _elem216.read(iprot);
            struct.tabletMetaInfos.add(_elem216);
          }
        }
        struct.setTabletMetaInfosIsSet(true);
      }
