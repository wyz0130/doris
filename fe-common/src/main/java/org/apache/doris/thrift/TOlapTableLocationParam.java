            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<TTabletLocation>(_list170.size);
                @org.apache.thrift.annotation.Nullable TTabletLocation _elem171;
                for (int _i172 = 0; _i172 < _list170.size; ++_i172)
                {
                  _elem171 = new TTabletLocation();
                  _elem171.read(iprot);
                  struct.tablets.add(_elem171);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.tablets != null) {
        oprot.writeFieldBegin(TABLETS_FIELD_DESC);
        {
          ...
          for (TTabletLocation _iter173 : struct.tablets)
          {
  ...
  private static class TOlapTableLocationParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableLocationParam> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.version);
      {
        ...
        for (TTabletLocation _iter174 : struct.tablets)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableLocationParam struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.tablets = new java.util.ArrayList<TTabletLocation>(_list175.size);
        @org.apache.thrift.annotation.Nullable TTabletLocation _elem176;
        for (int _i177 = 0; _i177 < _list175.size; ++_i177)
        {
          _elem176 = new TTabletLocation();
          _elem176.read(iprot);
          struct.tablets.add(_elem176);
        }
      }
      struct.setTabletsIsSet(true);
    }
