            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables = new java.util.ArrayList<TGetMetaTableMeta>(_list704.size);
                @org.apache.thrift.annotation.Nullable TGetMetaTableMeta _elem705;
                for (int _i706 = 0; _i706 < _list704.size; ++_i706)
                {
                  _elem705 = new TGetMetaTableMeta();
                  _elem705.read(iprot);
                  struct.tables.add(_elem705);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tables != null) {
        if (struct.isSetTables()) {
          oprot.writeFieldBegin(TABLES_FIELD_DESC);
          {
            ...
            for (TGetMetaTableMeta _iter707 : struct.tables)
            {
      ...
      if (struct.isSetTables()) {
        {
          ...
          for (TGetMetaTableMeta _iter708 : struct.tables)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.tables = new java.util.ArrayList<TGetMetaTableMeta>(_list709.size);
          @org.apache.thrift.annotation.Nullable TGetMetaTableMeta _elem710;
          for (int _i711 = 0; _i711 < _list709.size; ++_i711)
          {
            _elem710 = new TGetMetaTableMeta();
            _elem710.read(iprot);
            struct.tables.add(_elem710);
          }
        }
        struct.setTablesIsSet(true);
      }
