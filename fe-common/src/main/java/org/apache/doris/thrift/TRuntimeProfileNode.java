...
public class TRuntimeProfileNode implements org.apache.thrift.TBase<TRuntimeProfileNode, TRuntimeProfileNode._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeProfileNode> {
  ...
  private static final org.apache.thrift.protocol.TField IS_SINK_FIELD_DESC = new org.apache.thrift.protocol.TField("is_sink", org.apache.thrift.protocol.TType.BOOL, (short)10);
  ...
  public boolean is_sink; // optional
  ...
  private static final int __IS_SINK_ISSET_ID = 4;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.IS_SINK};
  ...
  static {
    ...
    tmpMap.put(_Fields.TIMESTAMP, new org.apache.thrift.meta_data.FieldMetaData("timestamp", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.IS_SINK, new org.apache.thrift.meta_data.FieldMetaData("is_sink", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TRuntimeProfileNode setIsSink(boolean is_sink) {
    this.is_sink = is_sink;
    setIsSinkIsSet(true);
    return this;
  }

  public void unsetIsSink() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __IS_SINK_ISSET_ID);
  }

  /** Returns true if field is_sink is set (has been assigned a value) and false otherwise */
  public boolean isSetIsSink() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __IS_SINK_ISSET_ID);
  }

  public void setIsSinkIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __IS_SINK_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case IS_SINK:
      if (value == null) {
        ...
        setIsSink((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TRuntimeProfileNode that) {
    ...
    boolean this_present_is_sink = true && this.isSetIsSink();
    boolean that_present_is_sink = true && that.isSetIsSink();
    if (this_present_is_sink || that_present_is_sink) {
      if (!(this_present_is_sink && that_present_is_sink))
        return false;
      if (this.is_sink != that.is_sink)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetIsSink()) ? 131071 : 524287);
    if (isSetIsSink())
      hashCode = hashCode * 8191 + ((is_sink) ? 131071 : 524287);
  ...
  public int compareTo(TRuntimeProfileNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIsSink(), other.isSetIsSink());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIsSink()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_sink, other.is_sink);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TRuntimeProfileNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRuntimeProfileNode> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // IS_SINK
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_sink = iprot.readBool();
              struct.setIsSinkIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.isSetIsSink()) {
        oprot.writeFieldBegin(IS_SINK_FIELD_DESC);
        oprot.writeBool(struct.is_sink);
        oprot.writeFieldEnd();
      }
