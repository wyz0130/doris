...
public class TQueryOptions implements org.apache.thrift.TBase<TQueryOptions, TQueryOptions._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryOptions> {
  ...
  private static final org.apache.thrift.protocol.TField WAIT_FULL_BLOCK_SCHEDULE_TIMES_FIELD_DESC = new org.apache.thrift.protocol.TField("wait_full_block_schedule_times", org.apache.thrift.protocol.TType.I32, (short)92);
  ...
  public int wait_full_block_schedule_times; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WAIT_FULL_BLOCK_SCHEDULE_TIMES((short)92, "wait_full_block_schedule_times"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 92: // WAIT_FULL_BLOCK_SCHEDULE_TIMES
          return WAIT_FULL_BLOCK_SCHEDULE_TIMES;
  ...
  static {
    ...
    tmpMap.put(_Fields.RUNTIME_FILTER_WAIT_INFINITELY, new org.apache.thrift.meta_data.FieldMetaData("runtime_filter_wait_infinitely", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.WAIT_FULL_BLOCK_SCHEDULE_TIMES, new org.apache.thrift.meta_data.FieldMetaData("wait_full_block_schedule_times", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public TQueryOptions() {
    ...
    this.wait_full_block_schedule_times = 1;
  ...
  public TQueryOptions(TQueryOptions other) {
    ...
    this.wait_full_block_schedule_times = other.wait_full_block_schedule_times;
  ...
  public int getWaitFullBlockScheduleTimes() {
    return this.wait_full_block_schedule_times;
  }

  public TQueryOptions setWaitFullBlockScheduleTimes(int wait_full_block_schedule_times) {
    this.wait_full_block_schedule_times = wait_full_block_schedule_times;
    setWaitFullBlockScheduleTimesIsSet(true);
    return this;
  }

  public void unsetWaitFullBlockScheduleTimes() {
    __isset_bit_vector.clear(__WAIT_FULL_BLOCK_SCHEDULE_TIMES_ISSET_ID);
  }

  /** Returns true if field wait_full_block_schedule_times is set (has been assigned a value) and false otherwise */
  public boolean isSetWaitFullBlockScheduleTimes() {
    return __isset_bit_vector.get(__WAIT_FULL_BLOCK_SCHEDULE_TIMES_ISSET_ID);
  }

  public void setWaitFullBlockScheduleTimesIsSet(boolean value) {
    __isset_bit_vector.set(__WAIT_FULL_BLOCK_SCHEDULE_TIMES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case WAIT_FULL_BLOCK_SCHEDULE_TIMES:
      if (value == null) {
        unsetWaitFullBlockScheduleTimes();
      } else {
        setWaitFullBlockScheduleTimes((java.lang.Integer)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case WAIT_FULL_BLOCK_SCHEDULE_TIMES:
      return getWaitFullBlockScheduleTimes();
  ...
  public boolean isSet(_Fields field) {
    ...
    case WAIT_FULL_BLOCK_SCHEDULE_TIMES:
      return isSetWaitFullBlockScheduleTimes();
    case INVERTED_INDEX_MAX_EXPANSIONS:
  ...
  public boolean equals(TQueryOptions that) {
    ...
    boolean this_present_wait_full_block_schedule_times = true && this.isSetWaitFullBlockScheduleTimes();
    boolean that_present_wait_full_block_schedule_times = true && that.isSetWaitFullBlockScheduleTimes();
    if (this_present_wait_full_block_schedule_times || that_present_wait_full_block_schedule_times) {
      if (!(this_present_wait_full_block_schedule_times && that_present_wait_full_block_schedule_times))
        return false;
      if (this.wait_full_block_schedule_times != that.wait_full_block_schedule_times)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWaitFullBlockScheduleTimes()) ? 131071 : 524287);
    if (isSetWaitFullBlockScheduleTimes())
      hashCode = hashCode * 8191 + wait_full_block_schedule_times;
  ...
  public int compareTo(TQueryOptions other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetWaitFullBlockScheduleTimes(), other.isSetWaitFullBlockScheduleTimes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWaitFullBlockScheduleTimes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wait_full_block_schedule_times, other.wait_full_block_schedule_times);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetWaitFullBlockScheduleTimes()) {
      if (!first) sb.append(", ");
      sb.append("wait_full_block_schedule_times:");
      sb.append(this.wait_full_block_schedule_times);
      first = false;
    }
    if (isSetInvertedIndexMaxExpansions()) {
      if (!first) sb.append(", ");
  ...
  private static class TQueryOptionsStandardScheme extends org.apache.thrift.scheme.StandardScheme<TQueryOptions> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TQueryOptions struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 92: // WAIT_FULL_BLOCK_SCHEDULE_TIMES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.wait_full_block_schedule_times = iprot.readI32();
              struct.setWaitFullBlockScheduleTimesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TQueryOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetWaitFullBlockScheduleTimes()) {
        oprot.writeFieldBegin(WAIT_FULL_BLOCK_SCHEDULE_TIMES_FIELD_DESC);
        oprot.writeI32(struct.wait_full_block_schedule_times);
        oprot.writeFieldEnd();
      }
  ...
  private static class TQueryOptionsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TQueryOptions> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TQueryOptions struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBitSet(optionals, 98);
      if (struct.isSetAbortOnError()) {
        oprot.writeBool(struct.abort_on_error);
      }
      if (struct.isSetMaxErrors()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TQueryOptions struct) throws org.apache.thrift.TException {
      ...
      java.util.BitSet incoming = iprot.readBitSet(98);
      if (incoming.get(0)) {
        struct.abort_on_error = iprot.readBool();
        struct.setAbortOnErrorIsSet(true);
      }
