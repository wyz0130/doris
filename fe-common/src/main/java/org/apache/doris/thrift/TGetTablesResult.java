            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables = new java.util.ArrayList<java.lang.String>(_list156.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TGetTablesResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.tables != null) {
        oprot.writeFieldBegin(TABLES_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter159 : struct.tables)
          {
      ...
      if (struct.isSetTables()) {
        {
          ...
          for (java.lang.String _iter160 : struct.tables)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tables = new java.util.ArrayList<java.lang.String>(_list161.size);
