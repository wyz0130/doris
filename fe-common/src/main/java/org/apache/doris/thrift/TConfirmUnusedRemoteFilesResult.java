            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirmed_tablets = new java.util.ArrayList<java.lang.Long>(_list424.size);
                long _elem425;
                for (int _i426 = 0; _i426 < _list424.size; ++_i426)
                {
                  _elem425 = iprot.readI64();
                  struct.confirmed_tablets.add(_elem425);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirmed_tablets != null) {
        if (struct.isSetConfirmedTablets()) {
          oprot.writeFieldBegin(CONFIRMED_TABLETS_FIELD_DESC);
          {
            ...
            for (long _iter427 : struct.confirmed_tablets)
            {
      ...
      if (struct.isSetConfirmedTablets()) {
        {
          ...
          for (long _iter428 : struct.confirmed_tablets)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirmed_tablets = new java.util.ArrayList<java.lang.Long>(_list429.size);
          long _elem430;
          for (int _i431 = 0; _i431 < _list429.size; ++_i431)
          {
            _elem430 = iprot.readI64();
            struct.confirmed_tablets.add(_elem430);
          }
        }
        struct.setConfirmedTabletsIsSet(true);
      }
