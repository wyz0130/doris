...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.CLUSTER,_Fields.USER_IP,_Fields.COMMIT_INFOS,_Fields.AUTH_CODE,_Fields.TXN_COMMIT_ATTACHMENT,_Fields.THRIFT_RPC_TIMEOUT_MS,_Fields.TOKEN,_Fields.DB_ID,_Fields.TBLS,_Fields.TABLE_ID};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list352.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem353;
                for (int _i354 = 0; _i354 < _list352.size; ++_i354)
                {
                  _elem353 = new org.apache.doris.thrift.TTabletCommitInfo();
                  _elem353.read(iprot);
                  struct.commitInfos.add(_elem353);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tbls = new java.util.ArrayList<java.lang.String>(_list355.size);
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletCommitInfo _iter358 : struct.commitInfos)
            {
      ...
      if (struct.tbls != null) {
        if (struct.isSetTbls()) {
          oprot.writeFieldBegin(TBLS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter359 : struct.tbls)
            {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletCommitInfo _iter360 : struct.commitInfos)
          {
      ...
      if (struct.isSetTbls()) {
        {
          ...
          for (java.lang.String _iter361 : struct.tbls)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<org.apache.doris.thrift.TTabletCommitInfo>(_list362.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletCommitInfo _elem363;
          for (int _i364 = 0; _i364 < _list362.size; ++_i364)
          {
            _elem363 = new org.apache.doris.thrift.TTabletCommitInfo();
            _elem363.read(iprot);
            struct.commitInfos.add(_elem363);
          }
        }
        struct.setCommitInfosIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.tbls = new java.util.ArrayList<java.lang.String>(_list365.size);
