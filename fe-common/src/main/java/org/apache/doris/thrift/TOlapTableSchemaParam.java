...
public class TOlapTableSchemaParam implements org.apache.thrift.TBase<TOlapTableSchemaParam, TOlapTableSchemaParam._Fields>, java.io.Serializable, Cloneable, Comparable<TOlapTableSchemaParam> {
  ...
  private static final _Fields optionals[] = {_Fields.IS_DYNAMIC_SCHEMA,_Fields.IS_PARTIAL_UPDATE,_Fields.PARTIAL_UPDATE_INPUT_COLUMNS,_Fields.IS_STRICT_MODE,_Fields.AUTO_INCREMENT_COLUMN};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slot_descs = new java.util.ArrayList<TSlotDescriptor>(_list138.size);
                @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem139;
                for (int _i140 = 0; _i140 < _list138.size; ++_i140)
                {
                  _elem139 = new TSlotDescriptor();
                  _elem139.read(iprot);
                  struct.slot_descs.add(_elem139);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes = new java.util.ArrayList<TOlapTableIndexSchema>(_list141.size);
                @org.apache.thrift.annotation.Nullable TOlapTableIndexSchema _elem142;
                for (int _i143 = 0; _i143 < _list141.size; ++_i143)
                {
                  _elem142 = new TOlapTableIndexSchema();
                  _elem142.read(iprot);
                  struct.indexes.add(_elem142);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partial_update_input_columns = new java.util.ArrayList<java.lang.String>(_list144.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem145;
                for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                {
                  _elem145 = iprot.readString();
                  struct.partial_update_input_columns.add(_elem145);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTableSchemaParam struct) throws org.apache.thrift.TException {
      ...
      if (struct.slot_descs != null) {
        oprot.writeFieldBegin(SLOT_DESCS_FIELD_DESC);
        {
          ...
          for (TSlotDescriptor _iter147 : struct.slot_descs)
          {
      ...
      if (struct.indexes != null) {
        oprot.writeFieldBegin(INDEXES_FIELD_DESC);
        {
          ...
          for (TOlapTableIndexSchema _iter148 : struct.indexes)
          {
      ...
      if (struct.partial_update_input_columns != null) {
        if (struct.isSetPartialUpdateInputColumns()) {
          oprot.writeFieldBegin(PARTIAL_UPDATE_INPUT_COLUMNS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter149 : struct.partial_update_input_columns)
            {
  ...
  private static class TOlapTableSchemaParamTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTableSchemaParam> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTableSchemaParam struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.version);
      {
        ...
        for (TSlotDescriptor _iter150 : struct.slot_descs)
        {
      ...
      struct.tuple_desc.write(oprot);
      {
        ...
        for (TOlapTableIndexSchema _iter151 : struct.indexes)
        {
      ...
      if (struct.isSetPartialUpdateInputColumns()) {
        {
          ...
          for (java.lang.String _iter152 : struct.partial_update_input_columns)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTableSchemaParam struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.slot_descs = new java.util.ArrayList<TSlotDescriptor>(_list153.size);
        @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem154;
        for (int _i155 = 0; _i155 < _list153.size; ++_i155)
        {
          _elem154 = new TSlotDescriptor();
          _elem154.read(iprot);
          struct.slot_descs.add(_elem154);
        }
      }
      struct.setSlotDescsIsSet(true);
      struct.tuple_desc = new TTupleDescriptor();
      ...
      struct.setTupleDescIsSet(true);
      {
        ...
        struct.indexes = new java.util.ArrayList<TOlapTableIndexSchema>(_list156.size);
        @org.apache.thrift.annotation.Nullable TOlapTableIndexSchema _elem157;
        for (int _i158 = 0; _i158 < _list156.size; ++_i158)
        {
          _elem157 = new TOlapTableIndexSchema();
          _elem157.read(iprot);
          struct.indexes.add(_elem157);
        }
      }
      struct.setIndexesIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.partial_update_input_columns = new java.util.ArrayList<java.lang.String>(_list159.size);
          ...
          for (int _i161 = 0; _i161 < _list159.size; ++_i161)
          {
            ...
            struct.partial_update_input_columns.add(_elem160);
          }
        }
        struct.setPartialUpdateInputColumnsIsSet(true);
      }
