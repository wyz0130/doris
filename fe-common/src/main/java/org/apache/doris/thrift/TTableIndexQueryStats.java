            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list448.size);
                @org.apache.thrift.annotation.Nullable TTableQueryStats _elem449;
                for (int _i450 = 0; _i450 < _list448.size; ++_i450)
                {
                  _elem449 = new TTableQueryStats();
                  _elem449.read(iprot);
                  struct.table_stats.add(_elem449);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_stats != null) {
        if (struct.isSetTableStats()) {
          oprot.writeFieldBegin(TABLE_STATS_FIELD_DESC);
          {
            ...
            for (TTableQueryStats _iter451 : struct.table_stats)
            {
      ...
      if (struct.isSetTableStats()) {
        {
          ...
          for (TTableQueryStats _iter452 : struct.table_stats)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.table_stats = new java.util.ArrayList<TTableQueryStats>(_list453.size);
          @org.apache.thrift.annotation.Nullable TTableQueryStats _elem454;
          for (int _i455 = 0; _i455 < _list453.size; ++_i455)
          {
            _elem454 = new TTableQueryStats();
            _elem454.read(iprot);
            struct.table_stats.add(_elem454);
          }
        }
        struct.setTableStatsIsSet(true);
      }
