            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map140.size);
                ...
                for (int _i143 = 0; _i143 < _map140.size; ++_i143)
                {
                  ...
                  struct.src_dest_map.put(_key141, _val142);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map144.size);
                ...
                for (int _i147 = 0; _i147 < _map144.size; ++_i147)
                {
                  ...
                  struct.broker_prop.put(_key145, _val146);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.remote_tablet_snapshots = new java.util.ArrayList<TRemoteTabletSnapshot>(_list148.size);
                @org.apache.thrift.annotation.Nullable TRemoteTabletSnapshot _elem149;
                for (int _i150 = 0; _i150 < _list148.size; ++_i150)
                {
                  _elem149 = new TRemoteTabletSnapshot();
                  _elem149.read(iprot);
                  struct.remote_tablet_snapshots.add(_elem149);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter151 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBrokerProp()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter152 : struct.broker_prop.entrySet())
            {
      ...
      if (struct.remote_tablet_snapshots != null) {
        if (struct.isSetRemoteTabletSnapshots()) {
          oprot.writeFieldBegin(REMOTE_TABLET_SNAPSHOTS_FIELD_DESC);
          {
            ...
            for (TRemoteTabletSnapshot _iter153 : struct.remote_tablet_snapshots)
            {
  ...
  private static class TDownloadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDownloadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter154 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBrokerProp()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter155 : struct.broker_prop.entrySet())
          {
      ...
      if (struct.isSetRemoteTabletSnapshots()) {
        {
          ...
          for (TRemoteTabletSnapshot _iter156 : struct.remote_tablet_snapshots)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJobIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map157 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map157.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key158;
        ...
        for (int _i160 = 0; _i160 < _map157.size; ++_i160)
        {
          ...
          struct.src_dest_map.put(_key158, _val159);
        }
      }
      struct.setSrcDestMapIsSet(true);
      struct.broker_addr = new org.apache.doris.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map161 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map161.size);
          ...
          for (int _i164 = 0; _i164 < _map161.size; ++_i164)
          {
            ...
            struct.broker_prop.put(_key162, _val163);
          }
        }
        struct.setBrokerPropIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.remote_tablet_snapshots = new java.util.ArrayList<TRemoteTabletSnapshot>(_list165.size);
          @org.apache.thrift.annotation.Nullable TRemoteTabletSnapshot _elem166;
          for (int _i167 = 0; _i167 < _list165.size; ++_i167)
          {
            _elem166 = new TRemoteTabletSnapshot();
            _elem166.read(iprot);
            struct.remote_tablet_snapshots.add(_elem166);
          }
        }
        struct.setRemoteTabletSnapshotsIsSet(true);
      }
