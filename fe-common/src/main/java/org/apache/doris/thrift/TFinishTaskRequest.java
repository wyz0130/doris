...
public class TFinishTaskRequest implements org.apache.thrift.TBase<TFinishTaskRequest, TFinishTaskRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TFinishTaskRequest> {
      ...
      if (struct.finish_tablet_infos != null) {
        if (struct.isSetFinishTabletInfos()) {
          oprot.writeFieldBegin(FINISH_TABLET_INFOS_FIELD_DESC);
          {
            ...
            for (TTabletInfo _iter35 : struct.finish_tablet_infos)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.error_tablet_ids != null) {
        if (struct.isSetErrorTabletIds()) {
          oprot.writeFieldBegin(ERROR_TABLET_IDS_FIELD_DESC);
          {
            ...
            for (long _iter36 : struct.error_tablet_ids)
            {
      ...
      if (struct.snapshot_files != null) {
        if (struct.isSetSnapshotFiles()) {
          oprot.writeFieldBegin(SNAPSHOT_FILES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter37 : struct.snapshot_files)
            {
      ...
      if (struct.tablet_files != null) {
        if (struct.isSetTabletFiles()) {
          oprot.writeFieldBegin(TABLET_FILES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.util.List<java.lang.String>> _iter38 : struct.tablet_files.entrySet())
            {
              oprot.writeI64(_iter38.getKey());
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, _iter38.getValue().size()));
                for (java.lang.String _iter39 : _iter38.getValue())
                {
      ...
      if (struct.downloaded_tablet_ids != null) {
        if (struct.isSetDownloadedTabletIds()) {
          oprot.writeFieldBegin(DOWNLOADED_TABLET_IDS_FIELD_DESC);
          {
            ...
            for (long _iter40 : struct.downloaded_tablet_ids)
            {
      ...
      if (struct.succ_tablets != null) {
        if (struct.isSetSuccTablets()) {
          oprot.writeFieldBegin(SUCC_TABLETS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter41 : struct.succ_tablets.entrySet())
            {
      ...
      if (struct.table_id_to_delta_num_rows != null) {
        if (struct.isSetTableIdToDeltaNumRows()) {
          oprot.writeFieldBegin(TABLE_ID_TO_DELTA_NUM_ROWS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter42 : struct.table_id_to_delta_num_rows.entrySet())
            {
  ...
  private static class TFinishTaskRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFinishTaskRequest> {
      ...
      if (struct.isSetFinishTabletInfos()) {
        {
          ...
          for (TTabletInfo _iter43 : struct.finish_tablet_infos)
          {
            _iter43.write(oprot);
          }
        }
      ...
      if (struct.isSetErrorTabletIds()) {
        {
          ...
          for (long _iter44 : struct.error_tablet_ids)
          {
      ...
      if (struct.isSetSnapshotFiles()) {
        {
          ...
          for (java.lang.String _iter45 : struct.snapshot_files)
          {
      ...
      if (struct.isSetTabletFiles()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.util.List<java.lang.String>> _iter46 : struct.tablet_files.entrySet())
          {
      ...
      if (struct.isSetDownloadedTabletIds()) {
        {
          ...
          for (long _iter48 : struct.downloaded_tablet_ids)
          {
      ...
      if (struct.isSetSuccTablets()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter49 : struct.succ_tablets.entrySet())
          {
      ...
      if (struct.isSetTableIdToDeltaNumRows()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, java.lang.Long> _iter50 : struct.table_id_to_delta_num_rows.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFinishTaskRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.finish_tablet_infos = new java.util.ArrayList<TTabletInfo>(_list51.size);
          @org.apache.thrift.annotation.Nullable TTabletInfo _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = new TTabletInfo();
            _elem52.read(iprot);
            struct.finish_tablet_infos.add(_elem52);
          }
        }
        struct.setFinishTabletInfosIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list54 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.error_tablet_ids = new java.util.ArrayList<java.lang.Long>(_list54.size);
          long _elem55;
          for (int _i56 = 0; _i56 < _list54.size; ++_i56)
          {
            _elem55 = iprot.readI64();
            struct.error_tablet_ids.add(_elem55);
          }
        }
        struct.setErrorTabletIdsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.snapshot_files = new java.util.ArrayList<java.lang.String>(_list57.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = iprot.readString();
            struct.snapshot_files.add(_elem58);
          }
        }
        struct.setSnapshotFilesIsSet(true);
      }
      if (incoming.get(8)) {
        {
          org.apache.thrift.protocol.TMap _map60 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.LIST); 
          struct.tablet_files = new java.util.HashMap<java.lang.Long,java.util.List<java.lang.String>>(2*_map60.size);
          long _key61;
          @org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> _val62;
          for (int _i63 = 0; _i63 < _map60.size; ++_i63)
          {
            _key61 = iprot.readI64();
            {
              org.apache.thrift.protocol.TList _list64 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
            ...
            struct.tablet_files.put(_key61, _val62);
          }
        }
        struct.setTabletFilesIsSet(true);
      }
      if (incoming.get(9)) {
        {
          org.apache.thrift.protocol.TList _list67 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.downloaded_tablet_ids = new java.util.ArrayList<java.lang.Long>(_list67.size);
          long _elem68;
          for (int _i69 = 0; _i69 < _list67.size; ++_i69)
          {
            _elem68 = iprot.readI64();
            struct.downloaded_tablet_ids.add(_elem68);
          }
        }
        struct.setDownloadedTabletIdsIsSet(true);
      }
      ...
      if (incoming.get(12)) {
        {
          org.apache.thrift.protocol.TMap _map70 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I64); 
          struct.succ_tablets = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map70.size);
          long _key71;
          long _val72;
          for (int _i73 = 0; _i73 < _map70.size; ++_i73)
          {
            _key71 = iprot.readI64();
            _val72 = iprot.readI64();
            struct.succ_tablets.put(_key71, _val72);
          }
        }
        struct.setSuccTabletsIsSet(true);
      }
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TMap _map74 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.I64); 
          struct.table_id_to_delta_num_rows = new java.util.HashMap<java.lang.Long,java.lang.Long>(2*_map74.size);
          long _key75;
          long _val76;
          for (int _i77 = 0; _i77 < _map74.size; ++_i77)
          {
            ...
            struct.table_id_to_delta_num_rows.put(_key75, _val76);
          }
        }
        struct.setTableIdToDeltaNumRowsIsSet(true);
      }
