            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_refs = new java.util.ArrayList<TTableRef>(_list534.size);
                @org.apache.thrift.annotation.Nullable TTableRef _elem535;
                for (int _i536 = 0; _i536 < _list534.size; ++_i536)
                {
                  _elem535 = new TTableRef();
                  _elem535.read(iprot);
                  struct.table_refs.add(_elem535);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map537.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key538;
                @org.apache.thrift.annotation.Nullable java.lang.String _val539;
                for (int _i540 = 0; _i540 < _map537.size; ++_i540)
                {
                  _key538 = iprot.readString();
                  _val539 = iprot.readString();
                  struct.properties.put(_key538, _val539);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.table_refs != null) {
        if (struct.isSetTableRefs()) {
          oprot.writeFieldBegin(TABLE_REFS_FIELD_DESC);
          {
            ...
            for (TTableRef _iter541 : struct.table_refs)
            {
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter542 : struct.properties.entrySet())
            {
      ...
      if (struct.isSetTableRefs()) {
        {
          ...
          for (TTableRef _iter543 : struct.table_refs)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter544 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.table_refs = new java.util.ArrayList<TTableRef>(_list545.size);
          @org.apache.thrift.annotation.Nullable TTableRef _elem546;
          for (int _i547 = 0; _i547 < _list545.size; ++_i547)
          {
            _elem546 = new TTableRef();
            _elem546.read(iprot);
            struct.table_refs.add(_elem546);
          }
        }
        struct.setTableRefsIsSet(true);
      }
      if (incoming.get(9)) {
        {
          ...
          struct.properties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map548.size);
          ...
          for (int _i551 = 0; _i551 < _map548.size; ++_i551)
          {
            ...
            struct.properties.put(_key549, _val550);
          }
        }
        struct.setPropertiesIsSet(true);
      }
