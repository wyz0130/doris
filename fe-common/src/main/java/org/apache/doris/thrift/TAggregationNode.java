...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregationNode> {
  ...
  private static final org.apache.thrift.protocol.TField IS_COLOCATE_FIELD_DESC = new org.apache.thrift.protocol.TField("is_colocate", org.apache.thrift.protocol.TType.BOOL, (short)9);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IS_COLOCATE((short)9, "is_colocate");
  ...
  private static final int __IS_COLOCATE_ISSET_ID = 5;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.GROUPING_EXPRS,_Fields.USE_STREAMING_PREAGGREGATION,_Fields.AGG_SORT_INFOS,_Fields.IS_FIRST_PHASE,_Fields.IS_COLOCATE};
  ...
  public TAggregationNode setIsColocate(boolean is_colocate) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list612.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem613;
                for (int _i614 = 0; _i614 < _list612.size; ++_i614)
                {
                  _elem613 = new org.apache.doris.thrift.TExpr();
                  _elem613.read(iprot);
                  struct.grouping_exprs.add(_elem613);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list615.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem616;
                for (int _i617 = 0; _i617 < _list615.size; ++_i617)
                {
                  _elem616 = new org.apache.doris.thrift.TExpr();
                  _elem616.read(iprot);
                  struct.aggregate_functions.add(_elem616);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.agg_sort_infos = new java.util.ArrayList<TSortInfo>(_list618.size);
                @org.apache.thrift.annotation.Nullable TSortInfo _elem619;
                for (int _i620 = 0; _i620 < _list618.size; ++_i620)
                {
                  _elem619 = new TSortInfo();
                  _elem619.read(iprot);
                  struct.agg_sort_infos.add(_elem619);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGroupingExprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter621 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter622 : struct.aggregate_functions)
          {
      ...
      if (struct.agg_sort_infos != null) {
        if (struct.isSetAggSortInfos()) {
          oprot.writeFieldBegin(AGG_SORT_INFOS_FIELD_DESC);
          {
            ...
            for (TSortInfo _iter623 : struct.agg_sort_infos)
            {
  ...
  private static class TAggregationNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter624 : struct.aggregate_functions)
        {
      ...
      if (struct.isSetGroupingExprs()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter625 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetAggSortInfos()) {
        {
          ...
          for (TSortInfo _iter626 : struct.agg_sort_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list627 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.aggregate_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list627.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem628;
        for (int _i629 = 0; _i629 < _list627.size; ++_i629)
        {
          _elem628 = new org.apache.doris.thrift.TExpr();
          _elem628.read(iprot);
          struct.aggregate_functions.add(_elem628);
        }
      }
      struct.setAggregateFunctionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list630 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.grouping_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list630.size);
          ...
          for (int _i632 = 0; _i632 < _list630.size; ++_i632)
          {
            ...
            _elem631.read(iprot);
            struct.grouping_exprs.add(_elem631);
          }
        }
        struct.setGroupingExprsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.agg_sort_infos = new java.util.ArrayList<TSortInfo>(_list633.size);
          @org.apache.thrift.annotation.Nullable TSortInfo _elem634;
          for (int _i635 = 0; _i635 < _list633.size; ++_i635)
          {
            _elem634 = new TSortInfo();
            _elem634.read(iprot);
            struct.agg_sort_infos.add(_elem634);
          }
        }
        struct.setAggSortInfosIsSet(true);
      }
