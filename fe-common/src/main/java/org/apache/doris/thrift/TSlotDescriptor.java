            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.column_paths = new java.util.ArrayList<java.lang.String>(_list8.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = iprot.readString();
                  struct.column_paths.add(_elem9);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.column_paths != null) {
        if (struct.isSetColumnPaths()) {
          oprot.writeFieldBegin(COLUMN_PATHS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter11 : struct.column_paths)
            {
      ...
      if (struct.isSetColumnPaths()) {
        {
          ...
          for (java.lang.String _iter12 : struct.column_paths)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.column_paths = new java.util.ArrayList<java.lang.String>(_list13.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readString();
            struct.column_paths.add(_elem14);
          }
        }
        struct.setColumnPathsIsSet(true);
      }
