            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes = new java.util.ArrayList<TOlapTableIndexTablets>(_list24.size);
                @org.apache.thrift.annotation.Nullable TOlapTableIndexTablets _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TOlapTableIndexTablets();
                  _elem25.read(iprot);
                  struct.indexes.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.start_keys = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list27.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new org.apache.doris.thrift.TExprNode();
                  _elem28.read(iprot);
                  struct.start_keys.add(_elem28);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.end_keys = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list30.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem31;
                for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                {
                  _elem31 = new org.apache.doris.thrift.TExprNode();
                  _elem31.read(iprot);
                  struct.end_keys.add(_elem31);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.in_keys = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExprNode>>(_list33.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExprNode> _elem34;
                for (int _i35 = 0; _i35 < _list33.size; ++_i35)
                {
                  {
                    org.apache.thrift.protocol.TList _list36 = iprot.readListBegin();
                    _elem34 = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list36.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem37;
                    for (int _i38 = 0; _i38 < _list36.size; ++_i38)
                    {
                      _elem37 = new org.apache.doris.thrift.TExprNode();
                      _elem37.read(iprot);
                      _elem34.add(_elem37);
                    }
                    iprot.readListEnd();
                  }
                  struct.in_keys.add(_elem34);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapTablePartition struct) throws org.apache.thrift.TException {
      ...
      if (struct.indexes != null) {
        oprot.writeFieldBegin(INDEXES_FIELD_DESC);
        {
          ...
          for (TOlapTableIndexTablets _iter39 : struct.indexes)
          {
            _iter39.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.start_keys != null) {
        if (struct.isSetStartKeys()) {
          oprot.writeFieldBegin(START_KEYS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExprNode _iter40 : struct.start_keys)
            {
              _iter40.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.end_keys != null) {
        if (struct.isSetEndKeys()) {
          oprot.writeFieldBegin(END_KEYS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExprNode _iter41 : struct.end_keys)
            {
              _iter41.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.in_keys != null) {
        if (struct.isSetInKeys()) {
          oprot.writeFieldBegin(IN_KEYS_FIELD_DESC);
          {
            ...
            for (java.util.List<org.apache.doris.thrift.TExprNode> _iter42 : struct.in_keys)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter42.size()));
                for (org.apache.doris.thrift.TExprNode _iter43 : _iter42)
                {
                  _iter43.write(oprot);
                }
                oprot.writeListEnd();
  ...
  private static class TOlapTablePartitionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapTablePartition> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapTablePartition struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.num_buckets);
      {
        ...
        for (TOlapTableIndexTablets _iter44 : struct.indexes)
        {
          _iter44.write(oprot);
        }
      }
      ...
      if (struct.isSetStartKeys()) {
        {
          ...
          for (org.apache.doris.thrift.TExprNode _iter45 : struct.start_keys)
          {
            _iter45.write(oprot);
          }
        }
      ...
      if (struct.isSetEndKeys()) {
        {
          ...
          for (org.apache.doris.thrift.TExprNode _iter46 : struct.end_keys)
          {
            _iter46.write(oprot);
          }
        }
      ...
      if (struct.isSetInKeys()) {
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExprNode> _iter47 : struct.in_keys)
          {
            {
              oprot.writeI32(_iter47.size());
              for (org.apache.doris.thrift.TExprNode _iter48 : _iter47)
              {
                _iter48.write(oprot);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapTablePartition struct) throws org.apache.thrift.TException {
      ...
      struct.setNumBucketsIsSet(true);
      {
        ...
        struct.indexes = new java.util.ArrayList<TOlapTableIndexTablets>(_list49.size);
        @org.apache.thrift.annotation.Nullable TOlapTableIndexTablets _elem50;
        for (int _i51 = 0; _i51 < _list49.size; ++_i51)
        {
          _elem50 = new TOlapTableIndexTablets();
          _elem50.read(iprot);
          struct.indexes.add(_elem50);
        }
      }
      struct.setIndexesIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.start_keys = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list52.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            _elem53 = new org.apache.doris.thrift.TExprNode();
            _elem53.read(iprot);
            struct.start_keys.add(_elem53);
          }
        }
        struct.setStartKeysIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.end_keys = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list55.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new org.apache.doris.thrift.TExprNode();
            _elem56.read(iprot);
            struct.end_keys.add(_elem56);
          }
        }
        struct.setEndKeysIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.in_keys = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExprNode>>(_list58.size);
          @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExprNode> _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            {
              org.apache.thrift.protocol.TList _list61 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
              _elem59 = new java.util.ArrayList<org.apache.doris.thrift.TExprNode>(_list61.size);
              @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExprNode _elem62;
              for (int _i63 = 0; _i63 < _list61.size; ++_i63)
              {
                _elem62 = new org.apache.doris.thrift.TExprNode();
                _elem62.read(iprot);
                _elem59.add(_elem62);
              }
            }
            struct.in_keys.add(_elem59);
          }
        }
        struct.setInKeysIsSet(true);
      }
