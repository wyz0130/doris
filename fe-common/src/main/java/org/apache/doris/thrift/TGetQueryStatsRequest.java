            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list440.size);
                long _elem441;
                for (int _i442 = 0; _i442 < _list440.size; ++_i442)
                {
                  _elem441 = iprot.readI64();
                  struct.replica_ids.add(_elem441);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.replica_ids != null) {
        if (struct.isSetReplicaIds()) {
          oprot.writeFieldBegin(REPLICA_IDS_FIELD_DESC);
          {
            ...
            for (long _iter443 : struct.replica_ids)
            {
      ...
      if (struct.isSetReplicaIds()) {
        {
          ...
          for (long _iter444 : struct.replica_ids)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.replica_ids = new java.util.ArrayList<java.lang.Long>(_list445.size);
          long _elem446;
          for (int _i447 = 0; _i447 < _list445.size; ++_i447)
          {
            _elem446 = iprot.readI64();
            struct.replica_ids.add(_elem446);
          }
        }
        struct.setReplicaIdsIsSet(true);
      }
