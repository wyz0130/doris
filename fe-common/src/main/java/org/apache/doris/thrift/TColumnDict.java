            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.str_dict = new java.util.ArrayList<java.lang.String>(_list118.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TColumnDict struct) throws org.apache.thrift.TException {
      ...
      if (struct.str_dict != null) {
        oprot.writeFieldBegin(STR_DICT_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter121 : struct.str_dict)
          {
      ...
      if (struct.isSetStrDict()) {
        {
          ...
          for (java.lang.String _iter122 : struct.str_dict)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.str_dict = new java.util.ArrayList<java.lang.String>(_list123.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem124;
          for (int _i125 = 0; _i125 < _list123.size; ++_i125)
          {
            _elem124 = iprot.readString();
            struct.str_dict.add(_elem124);
          }
        }
        struct.setStrDictIsSet(true);
      }
