            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list416.size);
                @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem417;
                for (int _i418 = 0; _i418 < _list416.size; ++_i418)
                {
                  _elem417 = new TTabletCooldownInfo();
                  _elem417.read(iprot);
                  struct.confirm_list.add(_elem417);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.confirm_list != null) {
        if (struct.isSetConfirmList()) {
          oprot.writeFieldBegin(CONFIRM_LIST_FIELD_DESC);
          {
            ...
            for (TTabletCooldownInfo _iter419 : struct.confirm_list)
            {
      ...
      if (struct.isSetConfirmList()) {
        {
          ...
          for (TTabletCooldownInfo _iter420 : struct.confirm_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confirm_list = new java.util.ArrayList<TTabletCooldownInfo>(_list421.size);
          @org.apache.thrift.annotation.Nullable TTabletCooldownInfo _elem422;
          for (int _i423 = 0; _i423 < _list421.size; ++_i423)
          {
            _elem422 = new TTabletCooldownInfo();
            _elem422.read(iprot);
            struct.confirm_list.add(_elem422);
          }
        }
        struct.setConfirmListIsSet(true);
      }
