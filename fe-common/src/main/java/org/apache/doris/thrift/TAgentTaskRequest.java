...
public class TAgentTaskRequest implements org.apache.thrift.TBase<TAgentTaskRequest, TAgentTaskRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TAgentTaskRequest> {
  ...
  private static final org.apache.thrift.protocol.TField CLEAN_TRASH_REQ_FIELD_DESC = new org.apache.thrift.protocol.TField("clean_trash_req", org.apache.thrift.protocol.TType.STRUCT, (short)34);
  ...
  public @org.apache.thrift.annotation.Nullable TCleanTrashReq clean_trash_req; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CLEAN_TRASH_REQ((short)34, "clean_trash_req");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 34: // CLEAN_TRASH_REQ
          return CLEAN_TRASH_REQ;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.CLEAN_TRASH_REQ, new org.apache.thrift.meta_data.FieldMetaData("clean_trash_req", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TCleanTrashReq.class)));
  ...
  public TAgentTaskRequest(TAgentTaskRequest other) {
    ...
    if (other.isSetCleanTrashReq()) {
      this.clean_trash_req = new TCleanTrashReq(other.clean_trash_req);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public TCleanTrashReq getCleanTrashReq() {
    return this.clean_trash_req;
  }

  public TAgentTaskRequest setCleanTrashReq(@org.apache.thrift.annotation.Nullable TCleanTrashReq clean_trash_req) {
    this.clean_trash_req = clean_trash_req;
    return this;
  }

  public void unsetCleanTrashReq() {
    this.clean_trash_req = null;
  }

  /** Returns true if field clean_trash_req is set (has been assigned a value) and false otherwise */
  public boolean isSetCleanTrashReq() {
    return this.clean_trash_req != null;
  }

  public void setCleanTrashReqIsSet(boolean value) {
    if (!value) {
      this.clean_trash_req = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CLEAN_TRASH_REQ:
      if (value == null) {
        unsetCleanTrashReq();
      } else {
        setCleanTrashReq((TCleanTrashReq)value);
      }
      break;
  ...
  public boolean equals(TAgentTaskRequest that) {
    ...
    boolean this_present_clean_trash_req = true && this.isSetCleanTrashReq();
    boolean that_present_clean_trash_req = true && that.isSetCleanTrashReq();
    if (this_present_clean_trash_req || that_present_clean_trash_req) {
      if (!(this_present_clean_trash_req && that_present_clean_trash_req))
        return false;
      if (!this.clean_trash_req.equals(that.clean_trash_req))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCleanTrashReq()) ? 131071 : 524287);
    if (isSetCleanTrashReq())
      hashCode = hashCode * 8191 + clean_trash_req.hashCode();
  ...
  public int compareTo(TAgentTaskRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCleanTrashReq(), other.isSetCleanTrashReq());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCleanTrashReq()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.clean_trash_req, other.clean_trash_req);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetCleanTrashReq()) {
      if (!first) sb.append(", ");
      sb.append("clean_trash_req:");
      if (this.clean_trash_req == null) {
        sb.append("null");
      } else {
        sb.append(this.clean_trash_req);
      }
      first = false;
    }
    sb.append(")");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (clean_trash_req != null) {
      clean_trash_req.validate();
    }
  }
  ...
  private static class TAgentTaskRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TAgentTaskRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAgentTaskRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 34: // CLEAN_TRASH_REQ
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.clean_trash_req = new TCleanTrashReq();
              struct.clean_trash_req.read(iprot);
              struct.setCleanTrashReqIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAgentTaskRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.clean_trash_req != null) {
        if (struct.isSetCleanTrashReq()) {
          oprot.writeFieldBegin(CLEAN_TRASH_REQ_FIELD_DESC);
          struct.clean_trash_req.write(oprot);
          oprot.writeFieldEnd();
        }
      }
