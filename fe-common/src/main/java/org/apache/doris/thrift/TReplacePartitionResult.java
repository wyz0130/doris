...
public class TReplacePartitionResult implements org.apache.thrift.TBase<TReplacePartitionResult, TReplacePartitionResult._Fields>, java.io.Serializable, Cloneable, Comparable<TReplacePartitionResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new java.util.ArrayList<org.apache.doris.thrift.TOlapTablePartition>(_list608.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTablePartition _elem609;
                for (int _i610 = 0; _i610 < _list608.size; ++_i610)
                {
                  _elem609 = new org.apache.doris.thrift.TOlapTablePartition();
                  _elem609.read(iprot);
                  struct.partitions.add(_elem609);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablets = new java.util.ArrayList<org.apache.doris.thrift.TTabletLocation>(_list611.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletLocation _elem612;
                for (int _i613 = 0; _i613 < _list611.size; ++_i613)
                {
                  _elem612 = new org.apache.doris.thrift.TTabletLocation();
                  _elem612.read(iprot);
                  struct.tablets.add(_elem612);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new java.util.ArrayList<org.apache.doris.thrift.TNodeInfo>(_list614.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNodeInfo _elem615;
                for (int _i616 = 0; _i616 < _list614.size; ++_i616)
                {
                  _elem615 = new org.apache.doris.thrift.TNodeInfo();
                  _elem615.read(iprot);
                  struct.nodes.add(_elem615);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.partitions != null) {
        if (struct.isSetPartitions()) {
          oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTablePartition _iter617 : struct.partitions)
            {
      ...
      if (struct.tablets != null) {
        if (struct.isSetTablets()) {
          oprot.writeFieldBegin(TABLETS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TTabletLocation _iter618 : struct.tablets)
            {
      ...
      if (struct.nodes != null) {
        if (struct.isSetNodes()) {
          oprot.writeFieldBegin(NODES_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TNodeInfo _iter619 : struct.nodes)
            {
  ...
  private static class TReplacePartitionResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TReplacePartitionResult> {
      ...
      if (struct.isSetPartitions()) {
        {
          ...
          for (org.apache.doris.thrift.TOlapTablePartition _iter620 : struct.partitions)
          {
      ...
      if (struct.isSetTablets()) {
        {
          ...
          for (org.apache.doris.thrift.TTabletLocation _iter621 : struct.tablets)
          {
      ...
      if (struct.isSetNodes()) {
        {
          ...
          for (org.apache.doris.thrift.TNodeInfo _iter622 : struct.nodes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TReplacePartitionResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partitions = new java.util.ArrayList<org.apache.doris.thrift.TOlapTablePartition>(_list623.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTablePartition _elem624;
          for (int _i625 = 0; _i625 < _list623.size; ++_i625)
          {
            _elem624 = new org.apache.doris.thrift.TOlapTablePartition();
            _elem624.read(iprot);
            struct.partitions.add(_elem624);
          }
        }
        struct.setPartitionsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list626 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.tablets = new java.util.ArrayList<org.apache.doris.thrift.TTabletLocation>(_list626.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTabletLocation _elem627;
          for (int _i628 = 0; _i628 < _list626.size; ++_i628)
          {
            _elem627 = new org.apache.doris.thrift.TTabletLocation();
            _elem627.read(iprot);
            struct.tablets.add(_elem627);
          }
        }
        struct.setTabletsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.nodes = new java.util.ArrayList<org.apache.doris.thrift.TNodeInfo>(_list629.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TNodeInfo _elem630;
          for (int _i631 = 0; _i631 < _list629.size; ++_i631)
          {
            _elem630 = new org.apache.doris.thrift.TNodeInfo();
            _elem630.read(iprot);
            struct.nodes.add(_elem630);
          }
        }
        struct.setNodesIsSet(true);
      }
