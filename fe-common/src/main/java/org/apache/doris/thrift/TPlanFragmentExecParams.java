...
public class TPlanFragmentExecParams implements org.apache.thrift.TBase<TPlanFragmentExecParams, TPlanFragmentExecParams._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanFragmentExecParams> {
  ...
  private static final org.apache.thrift.protocol.TField GROUP_COMMIT_FIELD_DESC = new org.apache.thrift.protocol.TField("group_commit", org.apache.thrift.protocol.TType.BOOL, (short)13);
  private static final org.apache.thrift.protocol.TField TOPN_FILTER_SOURCE_NODE_IDS_FIELD_DESC = new org.apache.thrift.protocol.TField("topn_filter_source_node_ids", org.apache.thrift.protocol.TType.LIST, (short)14);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    GROUP_COMMIT((short)13, "group_commit"),
    TOPN_FILTER_SOURCE_NODE_IDS((short)14, "topn_filter_source_node_ids");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 13: // GROUP_COMMIT
          return GROUP_COMMIT;
        case 14: // TOPN_FILTER_SOURCE_NODE_IDS
  ...
  private static final int __GROUP_COMMIT_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SENDER_ID,_Fields.NUM_SENDERS,_Fields.SEND_QUERY_STATISTICS_WITH_EVERY_BATCH,_Fields.RUNTIME_FILTER_PARAMS,_Fields.GROUP_COMMIT,_Fields.TOPN_FILTER_SOURCE_NODE_IDS};
  ...
  public TPlanFragmentExecParams setGroupCommit(boolean group_commit) {
  ...
  public TPlanFragmentExecParams setTopnFilterSourceNodeIds(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> topn_filter_source_node_ids) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topn_filter_source_node_ids = new java.util.ArrayList<java.lang.Integer>(_list88.size);
                int _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = iprot.readI32();
                  struct.topn_filter_source_node_ids.add(_elem89);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanFragmentExecParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.per_node_scan_ranges != null) {
        oprot.writeFieldBegin(PER_NODE_SCAN_RANGES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<TScanRangeParams>> _iter91 : struct.per_node_scan_ranges.entrySet())
          {
            oprot.writeI32(_iter91.getKey());
            {
              ...
              for (TScanRangeParams _iter92 : _iter91.getValue())
              {
                _iter92.write(oprot);
              }
              oprot.writeListEnd();
      ...
      if (struct.per_exch_num_senders != null) {
        oprot.writeFieldBegin(PER_EXCH_NUM_SENDERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter93 : struct.per_exch_num_senders.entrySet())
          {
      ...
      if (struct.destinations != null) {
        oprot.writeFieldBegin(DESTINATIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TPlanFragmentDestination _iter94 : struct.destinations)
          {
            _iter94.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.topn_filter_source_node_ids != null) {
        if (struct.isSetTopnFilterSourceNodeIds()) {
          oprot.writeFieldBegin(TOPN_FILTER_SOURCE_NODE_IDS_FIELD_DESC);
          {
            ...
            for (int _iter95 : struct.topn_filter_source_node_ids)
            {
  ...
  private static class TPlanFragmentExecParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPlanFragmentExecParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlanFragmentExecParams struct) throws org.apache.thrift.TException {
      ...
      struct.fragment_instance_id.write(oprot);
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.util.List<TScanRangeParams>> _iter96 : struct.per_node_scan_ranges.entrySet())
        {
          oprot.writeI32(_iter96.getKey());
          {
            oprot.writeI32(_iter96.getValue().size());
            for (TScanRangeParams _iter97 : _iter96.getValue())
            {
              _iter97.write(oprot);
            }
          }
      ...
      }
      {
        ...
        for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter98 : struct.per_exch_num_senders.entrySet())
        {
      ...
      if (struct.isSetDestinations()) {
        {
          ...
          for (org.apache.doris.thrift.TPlanFragmentDestination _iter99 : struct.destinations)
          {
            _iter99.write(oprot);
          }
        }
      ...
      if (struct.isSetTopnFilterSourceNodeIds()) {
        {
          ...
          for (int _iter100 : struct.topn_filter_source_node_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlanFragmentExecParams struct) throws org.apache.thrift.TException {
      ...
      struct.setFragmentInstanceIdIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map101 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.LIST); 
        struct.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<TScanRangeParams>>(2*_map101.size);
        int _key102;
        @org.apache.thrift.annotation.Nullable java.util.List<TScanRangeParams> _val103;
        for (int _i104 = 0; _i104 < _map101.size; ++_i104)
        {
          _key102 = iprot.readI32();
          {
            ...
            _val103 = new java.util.ArrayList<TScanRangeParams>(_list105.size);
            @org.apache.thrift.annotation.Nullable TScanRangeParams _elem106;
            for (int _i107 = 0; _i107 < _list105.size; ++_i107)
            {
              _elem106 = new TScanRangeParams();
              _elem106.read(iprot);
              _val103.add(_elem106);
            }
          }
          struct.per_node_scan_ranges.put(_key102, _val103);
        }
      }
      struct.setPerNodeScanRangesIsSet(true);
      {
        ...
        struct.per_exch_num_senders = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map108.size);
        int _key109;
        int _val110;
        for (int _i111 = 0; _i111 < _map108.size; ++_i111)
        {
          ...
          struct.per_exch_num_senders.put(_key109, _val110);
        }
      }
      struct.setPerExchNumSendersIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list112 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.destinations = new java.util.ArrayList<org.apache.doris.thrift.TPlanFragmentDestination>(_list112.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPlanFragmentDestination _elem113;
          for (int _i114 = 0; _i114 < _list112.size; ++_i114)
          {
            _elem113 = new org.apache.doris.thrift.TPlanFragmentDestination();
            _elem113.read(iprot);
            struct.destinations.add(_elem113);
          }
        }
        struct.setDestinationsIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.topn_filter_source_node_ids = new java.util.ArrayList<java.lang.Integer>(_list115.size);
          int _elem116;
          for (int _i117 = 0; _i117 < _list115.size; ++_i117)
          {
            _elem116 = iprot.readI32();
            struct.topn_filter_source_node_ids.add(_elem116);
          }
        }
        struct.setTopnFilterSourceNodeIdsIsSet(true);
      }
