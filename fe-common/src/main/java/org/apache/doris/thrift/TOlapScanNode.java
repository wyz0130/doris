            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.topn_filter_source_node_ids = new java.util.ArrayList<java.lang.Integer>(_list478.size);
                int _elem479;
                for (int _i480 = 0; _i480 < _list478.size; ++_i480)
                {
                  _elem479 = iprot.readI32();
                  struct.topn_filter_source_node_ids.add(_elem479);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.key_column_name != null) {
        oprot.writeFieldBegin(KEY_COLUMN_NAME_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter481 : struct.key_column_name)
          {
      ...
      if (struct.key_column_type != null) {
        oprot.writeFieldBegin(KEY_COLUMN_TYPE_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TPrimitiveType _iter482 : struct.key_column_type)
          {
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumnsDesc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter483 : struct.columns_desc)
            {
      ...
      if (struct.indexes_desc != null) {
        if (struct.isSetIndexesDesc()) {
          oprot.writeFieldBegin(INDEXES_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TOlapTableIndex _iter484 : struct.indexes_desc)
            {
      ...
      if (struct.output_column_unique_ids != null) {
        if (struct.isSetOutputColumnUniqueIds()) {
          oprot.writeFieldBegin(OUTPUT_COLUMN_UNIQUE_IDS_FIELD_DESC);
          {
            ...
            for (int _iter485 : struct.output_column_unique_ids)
            {
      ...
      if (struct.distribute_column_ids != null) {
        if (struct.isSetDistributeColumnIds()) {
          oprot.writeFieldBegin(DISTRIBUTE_COLUMN_IDS_FIELD_DESC);
          {
            ...
            for (int _iter486 : struct.distribute_column_ids)
            {
      ...
      if (struct.topn_filter_source_node_ids != null) {
        if (struct.isSetTopnFilterSourceNodeIds()) {
          oprot.writeFieldBegin(TOPN_FILTER_SOURCE_NODE_IDS_FIELD_DESC);
          {
            ...
            for (int _iter487 : struct.topn_filter_source_node_ids)
            {
  ...
  private static class TOlapScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.lang.String _iter488 : struct.key_column_name)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TPrimitiveType _iter489 : struct.key_column_type)
        {
      ...
      if (struct.isSetColumnsDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter490 : struct.columns_desc)
          {
      ...
      if (struct.isSetIndexesDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TOlapTableIndex _iter491 : struct.indexes_desc)
          {
      ...
      if (struct.isSetOutputColumnUniqueIds()) {
        {
          ...
          for (int _iter492 : struct.output_column_unique_ids)
          {
      ...
      if (struct.isSetDistributeColumnIds()) {
        {
          ...
          for (int _iter493 : struct.distribute_column_ids)
          {
      ...
      if (struct.isSetTopnFilterSourceNodeIds()) {
        {
          ...
          for (int _iter494 : struct.topn_filter_source_node_ids)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        ...
        struct.key_column_name = new java.util.ArrayList<java.lang.String>(_list495.size);
        ...
        for (int _i497 = 0; _i497 < _list495.size; ++_i497)
        {
          ...
          struct.key_column_name.add(_elem496);
        }
      }
      struct.setKeyColumnNameIsSet(true);
      {
        org.apache.thrift.protocol.TList _list498 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
        struct.key_column_type = new java.util.ArrayList<org.apache.doris.thrift.TPrimitiveType>(_list498.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TPrimitiveType _elem499;
        for (int _i500 = 0; _i500 < _list498.size; ++_i500)
        {
          _elem499 = org.apache.doris.thrift.TPrimitiveType.findByValue(iprot.readI32());
          if (_elem499 != null)
          {
            struct.key_column_type.add(_elem499);
          }
        }
      }
      struct.setKeyColumnTypeIsSet(true);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.columns_desc = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list501.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem502;
          for (int _i503 = 0; _i503 < _list501.size; ++_i503)
          {
            _elem502 = new org.apache.doris.thrift.TColumn();
            _elem502.read(iprot);
            struct.columns_desc.add(_elem502);
          }
        }
        struct.setColumnsDescIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.indexes_desc = new java.util.ArrayList<org.apache.doris.thrift.TOlapTableIndex>(_list504.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TOlapTableIndex _elem505;
          for (int _i506 = 0; _i506 < _list504.size; ++_i506)
          {
            _elem505 = new org.apache.doris.thrift.TOlapTableIndex();
            _elem505.read(iprot);
            struct.indexes_desc.add(_elem505);
          }
        }
        struct.setIndexesDescIsSet(true);
      }
      if (incoming.get(10)) {
        {
          org.apache.thrift.protocol.TSet _set507 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_column_unique_ids = new java.util.HashSet<java.lang.Integer>(2*_set507.size);
          int _elem508;
          for (int _i509 = 0; _i509 < _set507.size; ++_i509)
          {
            _elem508 = iprot.readI32();
            struct.output_column_unique_ids.add(_elem508);
          }
        }
        struct.setOutputColumnUniqueIdsIsSet(true);
      }
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list510 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.distribute_column_ids = new java.util.ArrayList<java.lang.Integer>(_list510.size);
          int _elem511;
          for (int _i512 = 0; _i512 < _list510.size; ++_i512)
          {
            _elem511 = iprot.readI32();
            struct.distribute_column_ids.add(_elem511);
          }
        }
        struct.setDistributeColumnIdsIsSet(true);
      }
      ...
      if (incoming.get(13)) {
        {
          org.apache.thrift.protocol.TList _list513 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.topn_filter_source_node_ids = new java.util.ArrayList<java.lang.Integer>(_list513.size);
          int _elem514;
          for (int _i515 = 0; _i515 < _list513.size; ++_i515)
          {
            _elem514 = iprot.readI32();
            struct.topn_filter_source_node_ids.add(_elem514);
          }
        }
        struct.setTopnFilterSourceNodeIdsIsSet(true);
      }
