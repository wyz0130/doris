...
public class TBinlog implements org.apache.thrift.TBase<TBinlog, TBinlog._Fields>, java.io.Serializable, Cloneable, Comparable<TBinlog> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list492.size);
                long _elem493;
                for (int _i494 = 0; _i494 < _list492.size; ++_i494)
                {
                  _elem493 = iprot.readI64();
                  struct.table_ids.add(_elem493);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.table_ids != null) {
        if (struct.isSetTableIds()) {
          oprot.writeFieldBegin(TABLE_IDS_FIELD_DESC);
          {
            ...
            for (long _iter495 : struct.table_ids)
            {
  ...
  private static class TBinlogTupleScheme extends org.apache.thrift.scheme.TupleScheme<TBinlog> {
      ...
      if (struct.isSetTableIds()) {
        {
          ...
          for (long _iter496 : struct.table_ids)
          {
            oprot.writeI64(_iter496);
          }
        }
      }
      if (struct.isSetData()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TBinlog struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list497 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
          struct.table_ids = new java.util.ArrayList<java.lang.Long>(_list497.size);
          long _elem498;
          for (int _i499 = 0; _i499 < _list497.size; ++_i499)
          {
            _elem498 = iprot.readI64();
            struct.table_ids.add(_elem498);
          }
        }
        struct.setTableIdsIsSet(true);
      }
