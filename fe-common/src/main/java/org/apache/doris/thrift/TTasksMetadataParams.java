...
public class TTasksMetadataParams implements org.apache.thrift.TBase<TTasksMetadataParams, TTasksMetadataParams._Fields>, java.io.Serializable, Cloneable, Comparable<TTasksMetadataParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TTasksMetadataParams");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TTasksMetadataParamsStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TTasksMetadataParamsTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TTasksMetadataParams.class, metaDataMap);
  }

  public TTasksMetadataParams() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TTasksMetadataParams(TTasksMetadataParams other) {
    if (other.isSetType()) {
  ...
  public TTasksMetadataParams deepCopy() {
    return new TTasksMetadataParams(this);
  }
  ...
  public TTasksMetadataParams setType(@org.apache.thrift.annotation.Nullable java.lang.String type) {
    this.type = type;
    return this;
  }
  ...
  public TTasksMetadataParams setCurrentUserIdent(@org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TUserIdentity current_user_ident) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TTasksMetadataParams)
      return this.equals((TTasksMetadataParams)that);
    return false;
  }

  public boolean equals(TTasksMetadataParams that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TTasksMetadataParams other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TTasksMetadataParams(");
    boolean first = true;
  ...
  private static class TTasksMetadataParamsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TTasksMetadataParamsStandardScheme getScheme() {
      return new TTasksMetadataParamsStandardScheme();
    }
  }

  private static class TTasksMetadataParamsStandardScheme extends org.apache.thrift.scheme.StandardScheme<TTasksMetadataParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TTasksMetadataParams struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTasksMetadataParams struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TTasksMetadataParamsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TTasksMetadataParamsTupleScheme getScheme() {
      return new TTasksMetadataParamsTupleScheme();
    }
  }

  private static class TTasksMetadataParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTasksMetadataParams> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TTasksMetadataParams struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TTasksMetadataParams struct) throws org.apache.thrift.TException {
