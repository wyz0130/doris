...
public class TReportRequest implements org.apache.thrift.TBase<TReportRequest, TReportRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TReportRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTaskType _key87;
                @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Long> _val88;
                for (int _i89 = 0; _i89 < _map86.size; ++_i89)
                {
                  _key87 = org.apache.doris.thrift.TTaskType.findByValue(iprot.readI32());
                  {
                    org.apache.thrift.protocol.TSet _set90 = iprot.readSetBegin();
                    _val88 = new java.util.HashSet<java.lang.Long>(2*_set90.size);
                    long _elem91;
                  ...
                  if (_key87 != null)
                  {
                    struct.tasks.put(_key87, _val88);
                  }
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tablets = new java.util.HashMap<java.lang.Long,TTablet>(2*_map93.size);
                long _key94;
                @org.apache.thrift.annotation.Nullable TTablet _val95;
                for (int _i96 = 0; _i96 < _map93.size; ++_i96)
                {
                  _key94 = iprot.readI64();
                  _val95 = new TTablet();
                  _val95.read(iprot);
                  struct.tablets.put(_key94, _val95);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.disks = new java.util.HashMap<java.lang.String,TDisk>(2*_map97.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key98;
                @org.apache.thrift.annotation.Nullable TDisk _val99;
                for (int _i100 = 0; _i100 < _map97.size; ++_i100)
                {
                  _key98 = iprot.readString();
                  _val99 = new TDisk();
                  _val99.read(iprot);
                  struct.disks.put(_key98, _val99);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablet_list = new java.util.ArrayList<TTablet>(_list101.size);
                @org.apache.thrift.annotation.Nullable TTablet _elem102;
                for (int _i103 = 0; _i103 < _list101.size; ++_i103)
                {
                  _elem102 = new TTablet();
                  _elem102.read(iprot);
                  struct.tablet_list.add(_elem102);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.storage_policy = new java.util.ArrayList<org.apache.doris.thrift.TStoragePolicy>(_list104.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TStoragePolicy _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = new org.apache.doris.thrift.TStoragePolicy();
                  _elem105.read(iprot);
                  struct.storage_policy.add(_elem105);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resource = new java.util.ArrayList<org.apache.doris.thrift.TStorageResource>(_list107.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TStorageResource _elem108;
                for (int _i109 = 0; _i109 < _list107.size; ++_i109)
                {
                  _elem108 = new org.apache.doris.thrift.TStorageResource();
                  _elem108.read(iprot);
                  struct.resource.add(_elem108);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tasks != null) {
        if (struct.isSetTasks()) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<org.apache.doris.thrift.TTaskType, java.util.Set<java.lang.Long>> _iter110 : struct.tasks.entrySet())
            {
              oprot.writeI32(_iter110.getKey().getValue());
              {
                oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, _iter110.getValue().size()));
      ...
      if (struct.tablets != null) {
        if (struct.isSetTablets()) {
          oprot.writeFieldBegin(TABLETS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Long, TTablet> _iter112 : struct.tablets.entrySet())
            {
      ...
      if (struct.disks != null) {
        if (struct.isSetDisks()) {
          oprot.writeFieldBegin(DISKS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, TDisk> _iter113 : struct.disks.entrySet())
            {
      ...
      if (struct.tablet_list != null) {
        if (struct.isSetTabletList()) {
          oprot.writeFieldBegin(TABLET_LIST_FIELD_DESC);
          {
            ...
            for (TTablet _iter114 : struct.tablet_list)
            {
      ...
      if (struct.storage_policy != null) {
        if (struct.isSetStoragePolicy()) {
          oprot.writeFieldBegin(STORAGE_POLICY_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TStoragePolicy _iter115 : struct.storage_policy)
            {
      ...
      if (struct.resource != null) {
        if (struct.isSetResource()) {
          oprot.writeFieldBegin(RESOURCE_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TStorageResource _iter116 : struct.resource)
            {
  ...
  private static class TReportRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TReportRequest> {
      ...
      if (struct.isSetTasks()) {
        {
          ...
          for (java.util.Map.Entry<org.apache.doris.thrift.TTaskType, java.util.Set<java.lang.Long>> _iter117 : struct.tasks.entrySet())
          {
      ...
      if (struct.isSetTablets()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TTablet> _iter119 : struct.tablets.entrySet())
          {
      ...
      if (struct.isSetDisks()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, TDisk> _iter120 : struct.disks.entrySet())
          {
      ...
      if (struct.isSetTabletList()) {
        {
          ...
          for (TTablet _iter121 : struct.tablet_list)
          {
      ...
      if (struct.isSetStoragePolicy()) {
        {
          ...
          for (org.apache.doris.thrift.TStoragePolicy _iter122 : struct.storage_policy)
          {
      ...
      if (struct.isSetResource()) {
        {
          ...
          for (org.apache.doris.thrift.TStorageResource _iter123 : struct.resource)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TReportRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map124 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET); 
          struct.tasks = new java.util.EnumMap<org.apache.doris.thrift.TTaskType,java.util.Set<java.lang.Long>>(org.apache.doris.thrift.TTaskType.class);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TTaskType _key125;
          @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Long> _val126;
          for (int _i127 = 0; _i127 < _map124.size; ++_i127)
          {
            _key125 = org.apache.doris.thrift.TTaskType.findByValue(iprot.readI32());
            {
              org.apache.thrift.protocol.TSet _set128 = iprot.readSetBegin(org.apache.thrift.protocol.TType.I64);
              _val126 = new java.util.HashSet<java.lang.Long>(2*_set128.size);
              long _elem129;
            ...
            if (_key125 != null)
            {
              struct.tasks.put(_key125, _val126);
            }
          }
        }
        struct.setTasksIsSet(true);
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map131 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.tablets = new java.util.HashMap<java.lang.Long,TTablet>(2*_map131.size);
          long _key132;
          @org.apache.thrift.annotation.Nullable TTablet _val133;
          for (int _i134 = 0; _i134 < _map131.size; ++_i134)
          {
            _key132 = iprot.readI64();
            _val133 = new TTablet();
            _val133.read(iprot);
            struct.tablets.put(_key132, _val133);
          }
        }
        struct.setTabletsIsSet(true);
      }
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TMap _map135 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT); 
          struct.disks = new java.util.HashMap<java.lang.String,TDisk>(2*_map135.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _key136;
          @org.apache.thrift.annotation.Nullable TDisk _val137;
          for (int _i138 = 0; _i138 < _map135.size; ++_i138)
          {
            _key136 = iprot.readString();
            _val137 = new TDisk();
            _val137.read(iprot);
            struct.disks.put(_key136, _val137);
          }
        }
        struct.setDisksIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.tablet_list = new java.util.ArrayList<TTablet>(_list139.size);
          @org.apache.thrift.annotation.Nullable TTablet _elem140;
          for (int _i141 = 0; _i141 < _list139.size; ++_i141)
          {
            _elem140 = new TTablet();
            _elem140.read(iprot);
            struct.tablet_list.add(_elem140);
          }
        }
        struct.setTabletListIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TList _list142 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.storage_policy = new java.util.ArrayList<org.apache.doris.thrift.TStoragePolicy>(_list142.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TStoragePolicy _elem143;
          for (int _i144 = 0; _i144 < _list142.size; ++_i144)
          {
            _elem143 = new org.apache.doris.thrift.TStoragePolicy();
            _elem143.read(iprot);
            struct.storage_policy.add(_elem143);
          }
        }
        struct.setStoragePolicyIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.resource = new java.util.ArrayList<org.apache.doris.thrift.TStorageResource>(_list145.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TStorageResource _elem146;
          for (int _i147 = 0; _i147 < _list145.size; ++_i147)
          {
            _elem146 = new org.apache.doris.thrift.TStorageResource();
            _elem146.read(iprot);
            struct.resource.add(_elem146);
          }
        }
        struct.setResourceIsSet(true);
      }
