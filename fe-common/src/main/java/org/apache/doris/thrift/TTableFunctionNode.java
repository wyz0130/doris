...
public class TTableFunctionNode implements org.apache.thrift.TBase<TTableFunctionNode, TTableFunctionNode._Fields>, java.io.Serializable, Cloneable, Comparable<TTableFunctionNode> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fnCallExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list892.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem893;
                for (int _i894 = 0; _i894 < _list892.size; ++_i894)
                {
                  _elem893 = new org.apache.doris.thrift.TExpr();
                  _elem893.read(iprot);
                  struct.fnCallExprList.add(_elem893);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputSlotIds = new java.util.ArrayList<java.lang.Integer>(_list895.size);
                int _elem896;
                for (int _i897 = 0; _i897 < _list895.size; ++_i897)
                {
                  _elem896 = iprot.readI32();
                  struct.outputSlotIds.add(_elem896);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.fnCallExprList != null) {
        if (struct.isSetFnCallExprList()) {
          oprot.writeFieldBegin(FN_CALL_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter898 : struct.fnCallExprList)
            {
      ...
      if (struct.outputSlotIds != null) {
        if (struct.isSetOutputSlotIds()) {
          oprot.writeFieldBegin(OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter899 : struct.outputSlotIds)
            {
  ...
  private static class TTableFunctionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTableFunctionNode> {
      ...
      if (struct.isSetFnCallExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter900 : struct.fnCallExprList)
          {
      ...
      if (struct.isSetOutputSlotIds()) {
        {
          ...
          for (int _iter901 : struct.outputSlotIds)
          {
            oprot.writeI32(_iter901);
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTableFunctionNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list902 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.fnCallExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list902.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem903;
          for (int _i904 = 0; _i904 < _list902.size; ++_i904)
          {
            _elem903 = new org.apache.doris.thrift.TExpr();
            _elem903.read(iprot);
            struct.fnCallExprList.add(_elem903);
          }
        }
        struct.setFnCallExprListIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list905 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.outputSlotIds = new java.util.ArrayList<java.lang.Integer>(_list905.size);
          int _elem906;
          for (int _i907 = 0; _i907 < _list905.size; ++_i907)
          {
            _elem906 = iprot.readI32();
            struct.outputSlotIds.add(_elem906);
          }
        }
        struct.setOutputSlotIdsIsSet(true);
      }
