            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.delete_conditions = new java.util.ArrayList<org.apache.doris.thrift.TCondition>(_list96.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TCondition _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new org.apache.doris.thrift.TCondition();
                  _elem97.read(iprot);
                  struct.delete_conditions.add(_elem97);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_desc = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list99.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem100;
                for (int _i101 = 0; _i101 < _list99.size; ++_i101)
                {
                  _elem100 = new org.apache.doris.thrift.TColumn();
                  _elem100.read(iprot);
                  struct.columns_desc.add(_elem100);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.delete_conditions != null) {
        if (struct.isSetDeleteConditions()) {
          oprot.writeFieldBegin(DELETE_CONDITIONS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TCondition _iter102 : struct.delete_conditions)
            {
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumnsDesc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter103 : struct.columns_desc)
            {
      ...
      if (struct.isSetDeleteConditions()) {
        {
          ...
          for (org.apache.doris.thrift.TCondition _iter104 : struct.delete_conditions)
          {
      ...
      if (struct.isSetColumnsDesc()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter105 : struct.columns_desc)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.delete_conditions = new java.util.ArrayList<org.apache.doris.thrift.TCondition>(_list106.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TCondition _elem107;
          for (int _i108 = 0; _i108 < _list106.size; ++_i108)
          {
            _elem107 = new org.apache.doris.thrift.TCondition();
            _elem107.read(iprot);
            struct.delete_conditions.add(_elem107);
          }
        }
        struct.setDeleteConditionsIsSet(true);
      }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.columns_desc = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list109.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new org.apache.doris.thrift.TColumn();
            _elem110.read(iprot);
            struct.columns_desc.add(_elem110);
          }
        }
        struct.setColumnsDescIsSet(true);
      }
