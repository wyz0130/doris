            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.params_list = new java.util.ArrayList<TPipelineFragmentParams>(_list370.size);
                @org.apache.thrift.annotation.Nullable TPipelineFragmentParams _elem371;
                for (int _i372 = 0; _i372 < _list370.size; ++_i372)
                {
                  _elem371 = new TPipelineFragmentParams();
                  _elem371.read(iprot);
                  struct.params_list.add(_elem371);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.params_list != null) {
        if (struct.isSetParamsList()) {
          oprot.writeFieldBegin(PARAMS_LIST_FIELD_DESC);
          {
            ...
            for (TPipelineFragmentParams _iter373 : struct.params_list)
            {
      ...
      if (struct.isSetParamsList()) {
        {
          ...
          for (TPipelineFragmentParams _iter374 : struct.params_list)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.params_list = new java.util.ArrayList<TPipelineFragmentParams>(_list375.size);
          @org.apache.thrift.annotation.Nullable TPipelineFragmentParams _elem376;
          for (int _i377 = 0; _i377 < _list375.size; ++_i377)
          {
            _elem376 = new TPipelineFragmentParams();
            _elem376.read(iprot);
            struct.params_list.add(_elem376);
          }
        }
        struct.setParamsListIsSet(true);
      }
