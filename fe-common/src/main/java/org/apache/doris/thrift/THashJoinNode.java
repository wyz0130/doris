            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list516.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem517;
                for (int _i518 = 0; _i518 < _list516.size; ++_i518)
                {
                  _elem517 = new TEqJoinCondition();
                  _elem517.read(iprot);
                  struct.eq_join_conjuncts.add(_elem517);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list519.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem520;
                for (int _i521 = 0; _i521 < _list519.size; ++_i521)
                {
                  _elem520 = new org.apache.doris.thrift.TExpr();
                  _elem520.read(iprot);
                  struct.other_join_conjuncts.add(_elem520);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list522.size);
                int _elem523;
                for (int _i524 = 0; _i524 < _list522.size; ++_i524)
                {
                  _elem523 = iprot.readI32();
                  struct.hash_output_slot_ids.add(_elem523);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list525.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem526;
                for (int _i527 = 0; _i527 < _list525.size; ++_i527)
                {
                  _elem526 = new org.apache.doris.thrift.TExpr();
                  _elem526.read(iprot);
                  struct.srcExprList.add(_elem526);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list528.size);
                int _elem529;
                for (int _i530 = 0; _i530 < _list528.size; ++_i530)
                {
                  _elem529 = iprot.readI32();
                  struct.vintermediate_tuple_id_list.add(_elem529);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mark_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list531.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem532;
                for (int _i533 = 0; _i533 < _list531.size; ++_i533)
                {
                  _elem532 = new org.apache.doris.thrift.TExpr();
                  _elem532.read(iprot);
                  struct.mark_join_conjuncts.add(_elem532);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter534 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOtherJoinConjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter535 : struct.other_join_conjuncts)
            {
      ...
      if (struct.hash_output_slot_ids != null) {
        if (struct.isSetHashOutputSlotIds()) {
          oprot.writeFieldBegin(HASH_OUTPUT_SLOT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter536 : struct.hash_output_slot_ids)
            {
      ...
      if (struct.srcExprList != null) {
        if (struct.isSetSrcExprList()) {
          oprot.writeFieldBegin(SRC_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter537 : struct.srcExprList)
            {
      ...
      if (struct.vintermediate_tuple_id_list != null) {
        if (struct.isSetVintermediateTupleIdList()) {
          oprot.writeFieldBegin(VINTERMEDIATE_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter538 : struct.vintermediate_tuple_id_list)
            {
              oprot.writeI32(_iter538);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.mark_join_conjuncts != null) {
        if (struct.isSetMarkJoinConjuncts()) {
          oprot.writeFieldBegin(MARK_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter539 : struct.mark_join_conjuncts)
            {
  ...
  private static class THashJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<THashJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.join_op.getValue());
      {
        ...
        for (TEqJoinCondition _iter540 : struct.eq_join_conjuncts)
        {
      ...
      if (struct.isSetOtherJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter541 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetHashOutputSlotIds()) {
        {
          ...
          for (int _iter542 : struct.hash_output_slot_ids)
          {
            oprot.writeI32(_iter542);
          }
        }
      }
      if (struct.isSetSrcExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter543 : struct.srcExprList)
          {
      ...
      if (struct.isSetVintermediateTupleIdList()) {
        {
          ...
          for (int _iter544 : struct.vintermediate_tuple_id_list)
          {
            oprot.writeI32(_iter544);
          }
        }
      }
      if (struct.isSetIsBroadcastJoin()) {
      ...
      if (struct.isSetMarkJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter545 : struct.mark_join_conjuncts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, THashJoinNode struct) throws org.apache.thrift.TException {
      ...
      struct.setJoinOpIsSet(true);
      {
        org.apache.thrift.protocol.TList _list546 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list546.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem547;
        for (int _i548 = 0; _i548 < _list546.size; ++_i548)
        {
          _elem547 = new TEqJoinCondition();
          _elem547.read(iprot);
          struct.eq_join_conjuncts.add(_elem547);
        }
      }
      struct.setEqJoinConjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list549.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem550;
          for (int _i551 = 0; _i551 < _list549.size; ++_i551)
          {
            _elem550 = new org.apache.doris.thrift.TExpr();
            _elem550.read(iprot);
            struct.other_join_conjuncts.add(_elem550);
          }
        }
        struct.setOtherJoinConjunctsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          org.apache.thrift.protocol.TList _list552 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.hash_output_slot_ids = new java.util.ArrayList<java.lang.Integer>(_list552.size);
          int _elem553;
          for (int _i554 = 0; _i554 < _list552.size; ++_i554)
          {
            _elem553 = iprot.readI32();
            struct.hash_output_slot_ids.add(_elem553);
          }
        }
        struct.setHashOutputSlotIdsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list555.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem556;
          for (int _i557 = 0; _i557 < _list555.size; ++_i557)
          {
            _elem556 = new org.apache.doris.thrift.TExpr();
            _elem556.read(iprot);
            struct.srcExprList.add(_elem556);
          }
        }
        struct.setSrcExprListIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list558 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list558.size);
          int _elem559;
          for (int _i560 = 0; _i560 < _list558.size; ++_i560)
          {
            _elem559 = iprot.readI32();
            struct.vintermediate_tuple_id_list.add(_elem559);
          }
        }
        struct.setVintermediateTupleIdListIsSet(true);
      }
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.mark_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list561.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem562;
          for (int _i563 = 0; _i563 < _list561.size; ++_i563)
          {
            _elem562 = new org.apache.doris.thrift.TExpr();
            _elem562.read(iprot);
            struct.mark_join_conjuncts.add(_elem562);
          }
        }
        struct.setMarkJoinConjunctsIsSet(true);
      }
