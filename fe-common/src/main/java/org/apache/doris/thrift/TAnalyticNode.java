...
public class TAnalyticNode implements org.apache.thrift.TBase<TAnalyticNode, TAnalyticNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAnalyticNode> {
  ...
  private static final _Fields optionals[] = {_Fields.WINDOW,_Fields.BUFFERED_TUPLE_ID,_Fields.PARTITION_BY_EQ,_Fields.ORDER_BY_EQ,_Fields.IS_COLOCATE};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list716.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem717;
                for (int _i718 = 0; _i718 < _list716.size; ++_i718)
                {
                  _elem717 = new org.apache.doris.thrift.TExpr();
                  _elem717.read(iprot);
                  struct.partition_exprs.add(_elem717);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.order_by_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list719.size);
                ...
                for (int _i721 = 0; _i721 < _list719.size; ++_i721)
                {
                  ...
                  _elem720.read(iprot);
                  struct.order_by_exprs.add(_elem720);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analytic_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list722.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem723;
                for (int _i724 = 0; _i724 < _list722.size; ++_i724)
                {
                  _elem723 = new org.apache.doris.thrift.TExpr();
                  _elem723.read(iprot);
                  struct.analytic_functions.add(_elem723);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAnalyticNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.partition_exprs != null) {
        oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter725 : struct.partition_exprs)
          {
      ...
      if (struct.order_by_exprs != null) {
        oprot.writeFieldBegin(ORDER_BY_EXPRS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter726 : struct.order_by_exprs)
          {
      ...
      if (struct.analytic_functions != null) {
        oprot.writeFieldBegin(ANALYTIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter727 : struct.analytic_functions)
          {
  ...
  private static class TAnalyticNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAnalyticNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter728 : struct.partition_exprs)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter729 : struct.order_by_exprs)
        {
      ...
      }
      {
        ...
        for (org.apache.doris.thrift.TExpr _iter730 : struct.analytic_functions)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAnalyticNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.partition_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list731.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem732;
        for (int _i733 = 0; _i733 < _list731.size; ++_i733)
        {
          _elem732 = new org.apache.doris.thrift.TExpr();
          _elem732.read(iprot);
          struct.partition_exprs.add(_elem732);
        }
      }
      struct.setPartitionExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list734 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.order_by_exprs = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list734.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem735;
        for (int _i736 = 0; _i736 < _list734.size; ++_i736)
        {
          _elem735 = new org.apache.doris.thrift.TExpr();
          _elem735.read(iprot);
          struct.order_by_exprs.add(_elem735);
        }
      }
      struct.setOrderByExprsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list737 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.analytic_functions = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list737.size);
        @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem738;
        for (int _i739 = 0; _i739 < _list737.size; ++_i739)
        {
          _elem738 = new org.apache.doris.thrift.TExpr();
          _elem738.read(iprot);
          struct.analytic_functions.add(_elem738);
        }
      }
      struct.setAnalyticFunctionsIsSet(true);
      struct.intermediate_tuple_id = iprot.readI32();
