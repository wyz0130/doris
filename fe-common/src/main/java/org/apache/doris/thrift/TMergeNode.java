            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list740.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem741;
                for (int _i742 = 0; _i742 < _list740.size; ++_i742)
                {
                  {
                    org.apache.thrift.protocol.TList _list743 = iprot.readListBegin();
                    _elem741 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list743.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem744;
                    for (int _i745 = 0; _i745 < _list743.size; ++_i745)
                    {
                      _elem744 = new org.apache.doris.thrift.TExpr();
                      _elem744.read(iprot);
                      _elem741.add(_elem744);
                    }
                    iprot.readListEnd();
                  }
                  struct.result_expr_lists.add(_elem741);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list746.size);
                @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem747;
                for (int _i748 = 0; _i748 < _list746.size; ++_i748)
                {
                  {
                    org.apache.thrift.protocol.TList _list749 = iprot.readListBegin();
                    _elem747 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list749.size);
                    @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem750;
                    for (int _i751 = 0; _i751 < _list749.size; ++_i751)
                    {
                      _elem750 = new org.apache.doris.thrift.TExpr();
                      _elem750.read(iprot);
                      _elem747.add(_elem750);
                    }
                    iprot.readListEnd();
                  }
                  struct.const_expr_lists.add(_elem747);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter752 : struct.result_expr_lists)
          {
            {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<org.apache.doris.thrift.TExpr> _iter754 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter754.size()));
  ...
  private static class TMergeNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMergeNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter756 : struct.result_expr_lists)
        {
          {
      ...
      }
      {
        ...
        for (java.util.List<org.apache.doris.thrift.TExpr> _iter758 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter758.size());
            for (org.apache.doris.thrift.TExpr _iter759 : _iter758)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTupleIdIsSet(true);
      {
        org.apache.thrift.protocol.TList _list760 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list760.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem761;
        ...
        {
          {
            ...
            _elem761 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list763.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem764;
            for (int _i765 = 0; _i765 < _list763.size; ++_i765)
            {
              _elem764 = new org.apache.doris.thrift.TExpr();
              _elem764.read(iprot);
              _elem761.add(_elem764);
            }
          }
          struct.result_expr_lists.add(_elem761);
        }
      }
      struct.setResultExprListsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list766 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<org.apache.doris.thrift.TExpr>>(_list766.size);
        @org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> _elem767;
        ...
        {
          {
            ...
            _elem767 = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list769.size);
            @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem770;
            for (int _i771 = 0; _i771 < _list769.size; ++_i771)
            {
              _elem770 = new org.apache.doris.thrift.TExpr();
              _elem770.read(iprot);
              _elem767.add(_elem770);
            }
          }
          struct.const_expr_lists.add(_elem767);
        }
      }
      struct.setConstExprListsIsSet(true);
    }
