            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.materialized_view_params = new java.util.ArrayList<TAlterMaterializedViewParam>(_list48.size);
                @org.apache.thrift.annotation.Nullable TAlterMaterializedViewParam _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new TAlterMaterializedViewParam();
                  _elem49.read(iprot);
                  struct.materialized_view_params.add(_elem49);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list51.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem52;
                for (int _i53 = 0; _i53 < _list51.size; ++_i53)
                {
                  _elem52 = new org.apache.doris.thrift.TColumn();
                  _elem52.read(iprot);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TColumn _iter55 : struct.columns)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetMaterializedViewParams()) {
        {
          ...
          for (TAlterMaterializedViewParam _iter56 : struct.materialized_view_params)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (org.apache.doris.thrift.TColumn _iter57 : struct.columns)
          {
            _iter57.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.materialized_view_params = new java.util.ArrayList<TAlterMaterializedViewParam>(_list58.size);
          @org.apache.thrift.annotation.Nullable TAlterMaterializedViewParam _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = new TAlterMaterializedViewParam();
            _elem59.read(iprot);
            struct.materialized_view_params.add(_elem59);
          }
        }
        struct.setMaterializedViewParamsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.columns = new java.util.ArrayList<org.apache.doris.thrift.TColumn>(_list61.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TColumn _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new org.apache.doris.thrift.TColumn();
            _elem62.read(iprot);
