...
public class TNestedLoopJoinNode implements org.apache.thrift.TBase<TNestedLoopJoinNode, TNestedLoopJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TNestedLoopJoinNode> {
  ...
  private static final org.apache.thrift.protocol.TField MARK_JOIN_CONJUNCTS_FIELD_DESC = new org.apache.thrift.protocol.TField("mark_join_conjuncts", org.apache.thrift.protocol.TType.LIST, (short)9);
  private static final org.apache.thrift.protocol.TField USE_SPECIFIC_PROJECTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("use_specific_projections", org.apache.thrift.protocol.TType.BOOL, (short)10);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    MARK_JOIN_CONJUNCTS((short)9, "mark_join_conjuncts"),
    USE_SPECIFIC_PROJECTIONS((short)10, "use_specific_projections");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 9: // MARK_JOIN_CONJUNCTS
          return MARK_JOIN_CONJUNCTS;
        case 10: // USE_SPECIFIC_PROJECTIONS
  ...
  private static final int __USE_SPECIFIC_PROJECTIONS_ISSET_ID = 3;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.SRC_EXPR_LIST,_Fields.VOUTPUT_TUPLE_ID,_Fields.VINTERMEDIATE_TUPLE_ID_LIST,_Fields.IS_OUTPUT_LEFT_SIDE_ONLY,_Fields.VJOIN_CONJUNCT,_Fields.IS_MARK,_Fields.JOIN_CONJUNCTS,_Fields.MARK_JOIN_CONJUNCTS,_Fields.USE_SPECIFIC_PROJECTIONS};
  ...
  public TNestedLoopJoinNode setMarkJoinConjuncts(@org.apache.thrift.annotation.Nullable java.util.List<org.apache.doris.thrift.TExpr> mark_join_conjuncts) {
  ...
  public TNestedLoopJoinNode setUseSpecificProjections(boolean use_specific_projections) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list564.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem565;
                for (int _i566 = 0; _i566 < _list564.size; ++_i566)
                {
                  _elem565 = new org.apache.doris.thrift.TExpr();
                  _elem565.read(iprot);
                  struct.srcExprList.add(_elem565);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list567.size);
                int _elem568;
                for (int _i569 = 0; _i569 < _list567.size; ++_i569)
                {
                  _elem568 = iprot.readI32();
                  struct.vintermediate_tuple_id_list.add(_elem568);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list570.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem571;
                for (int _i572 = 0; _i572 < _list570.size; ++_i572)
                {
                  _elem571 = new org.apache.doris.thrift.TExpr();
                  _elem571.read(iprot);
                  struct.join_conjuncts.add(_elem571);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mark_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list573.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem574;
                for (int _i575 = 0; _i575 < _list573.size; ++_i575)
                {
                  _elem574 = new org.apache.doris.thrift.TExpr();
                  _elem574.read(iprot);
                  struct.mark_join_conjuncts.add(_elem574);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.srcExprList != null) {
        if (struct.isSetSrcExprList()) {
          oprot.writeFieldBegin(SRC_EXPR_LIST_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter576 : struct.srcExprList)
            {
      ...
      if (struct.vintermediate_tuple_id_list != null) {
        if (struct.isSetVintermediateTupleIdList()) {
          oprot.writeFieldBegin(VINTERMEDIATE_TUPLE_ID_LIST_FIELD_DESC);
          {
            ...
            for (int _iter577 : struct.vintermediate_tuple_id_list)
            {
              oprot.writeI32(_iter577);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.join_conjuncts != null) {
        if (struct.isSetJoinConjuncts()) {
          oprot.writeFieldBegin(JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter578 : struct.join_conjuncts)
            {
      ...
      if (struct.mark_join_conjuncts != null) {
        if (struct.isSetMarkJoinConjuncts()) {
          oprot.writeFieldBegin(MARK_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter579 : struct.mark_join_conjuncts)
            {
  ...
  private static class TNestedLoopJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TNestedLoopJoinNode> {
      ...
      if (struct.isSetSrcExprList()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter580 : struct.srcExprList)
          {
      ...
      if (struct.isSetVintermediateTupleIdList()) {
        {
          ...
          for (int _iter581 : struct.vintermediate_tuple_id_list)
          {
      ...
      if (struct.isSetJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter582 : struct.join_conjuncts)
          {
      ...
      if (struct.isSetMarkJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter583 : struct.mark_join_conjuncts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TNestedLoopJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list584 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.srcExprList = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list584.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem585;
          for (int _i586 = 0; _i586 < _list584.size; ++_i586)
          {
            _elem585 = new org.apache.doris.thrift.TExpr();
            _elem585.read(iprot);
            struct.srcExprList.add(_elem585);
          }
        }
        struct.setSrcExprListIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list587 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.vintermediate_tuple_id_list = new java.util.ArrayList<java.lang.Integer>(_list587.size);
          int _elem588;
          for (int _i589 = 0; _i589 < _list587.size; ++_i589)
          {
            _elem588 = iprot.readI32();
            struct.vintermediate_tuple_id_list.add(_elem588);
          }
        }
        struct.setVintermediateTupleIdListIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list590 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list590.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem591;
          for (int _i592 = 0; _i592 < _list590.size; ++_i592)
          {
            _elem591 = new org.apache.doris.thrift.TExpr();
            _elem591.read(iprot);
            struct.join_conjuncts.add(_elem591);
          }
        }
        struct.setJoinConjunctsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.mark_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list593.size);
          ...
          for (int _i595 = 0; _i595 < _list593.size; ++_i595)
          {
            ...
            _elem594.read(iprot);
            struct.mark_join_conjuncts.add(_elem594);
          }
        }
        struct.setMarkJoinConjunctsIsSet(true);
      }
