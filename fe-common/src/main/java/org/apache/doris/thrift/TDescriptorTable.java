            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list216.size);
                @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem217;
                for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                {
                  _elem217 = new TSlotDescriptor();
                  _elem217.read(iprot);
                  struct.slotDescriptors.add(_elem217);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list219.size);
                @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem220;
                for (int _i221 = 0; _i221 < _list219.size; ++_i221)
                {
                  _elem220 = new TTupleDescriptor();
                  _elem220.read(iprot);
                  struct.tupleDescriptors.add(_elem220);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list222.size);
                @org.apache.thrift.annotation.Nullable TTableDescriptor _elem223;
                for (int _i224 = 0; _i224 < _list222.size; ++_i224)
                {
                  _elem223 = new TTableDescriptor();
                  _elem223.read(iprot);
                  struct.tableDescriptors.add(_elem223);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDescriptorTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.slotDescriptors != null) {
        if (struct.isSetSlotDescriptors()) {
          oprot.writeFieldBegin(SLOT_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TSlotDescriptor _iter225 : struct.slotDescriptors)
            {
      ...
      if (struct.tupleDescriptors != null) {
        oprot.writeFieldBegin(TUPLE_DESCRIPTORS_FIELD_DESC);
        {
          ...
          for (TTupleDescriptor _iter226 : struct.tupleDescriptors)
          {
      ...
      if (struct.tableDescriptors != null) {
        if (struct.isSetTableDescriptors()) {
          oprot.writeFieldBegin(TABLE_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TTableDescriptor _iter227 : struct.tableDescriptors)
            {
  ...
  private static class TDescriptorTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDescriptorTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (TTupleDescriptor _iter228 : struct.tupleDescriptors)
        {
      ...
      if (struct.isSetSlotDescriptors()) {
        {
          ...
          for (TSlotDescriptor _iter229 : struct.slotDescriptors)
          {
      ...
      if (struct.isSetTableDescriptors()) {
        {
          ...
          for (TTableDescriptor _iter230 : struct.tableDescriptors)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list231.size);
        @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem232;
        for (int _i233 = 0; _i233 < _list231.size; ++_i233)
        {
          _elem232 = new TTupleDescriptor();
          _elem232.read(iprot);
          struct.tupleDescriptors.add(_elem232);
        }
      }
      struct.setTupleDescriptorsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list234.size);
          @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem235;
          for (int _i236 = 0; _i236 < _list234.size; ++_i236)
          {
            _elem235 = new TSlotDescriptor();
            _elem235.read(iprot);
            struct.slotDescriptors.add(_elem235);
          }
        }
        struct.setSlotDescriptorsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list237.size);
          @org.apache.thrift.annotation.Nullable TTableDescriptor _elem238;
          for (int _i239 = 0; _i239 < _list237.size; ++_i239)
          {
            _elem238 = new TTableDescriptor();
            _elem238.read(iprot);
            struct.tableDescriptors.add(_elem238);
          }
        }
        struct.setTableDescriptorsIsSet(true);
      }
