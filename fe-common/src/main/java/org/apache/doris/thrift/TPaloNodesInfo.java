            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nodes = new java.util.ArrayList<TNodeInfo>(_list178.size);
                @org.apache.thrift.annotation.Nullable TNodeInfo _elem179;
                for (int _i180 = 0; _i180 < _list178.size; ++_i180)
                {
                  _elem179 = new TNodeInfo();
                  _elem179.read(iprot);
                  struct.nodes.add(_elem179);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPaloNodesInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.nodes != null) {
        oprot.writeFieldBegin(NODES_FIELD_DESC);
        {
          ...
          for (TNodeInfo _iter181 : struct.nodes)
          {
  ...
  private static class TPaloNodesInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPaloNodesInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPaloNodesInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.version);
      {
        ...
        for (TNodeInfo _iter182 : struct.nodes)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPaloNodesInfo struct) throws org.apache.thrift.TException {
      ...
      struct.setVersionIsSet(true);
      {
        ...
        struct.nodes = new java.util.ArrayList<TNodeInfo>(_list183.size);
        @org.apache.thrift.annotation.Nullable TNodeInfo _elem184;
        for (int _i185 = 0; _i185 < _list183.size; ++_i185)
        {
          _elem184 = new TNodeInfo();
          _elem184.read(iprot);
          struct.nodes.add(_elem184);
        }
      }
      struct.setNodesIsSet(true);
    }
