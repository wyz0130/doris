            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.shareByGroup = new java.util.HashMap<java.lang.String,java.lang.Integer>(2*_map158.size);
                ...
                for (int _i161 = 0; _i161 < _map158.size; ++_i161)
                {
                  ...
                  struct.shareByGroup.put(_key159, _val160);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUserResource struct) throws org.apache.thrift.TException {
      ...
      if (struct.shareByGroup != null) {
        oprot.writeFieldBegin(SHARE_BY_GROUP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter162 : struct.shareByGroup.entrySet())
          {
  ...
  private static class TUserResourceTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUserResource> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUserResource struct) throws org.apache.thrift.TException {
      ...
      struct.resource.write(oprot);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.Integer> _iter163 : struct.shareByGroup.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUserResource struct) throws org.apache.thrift.TException {
      ...
      struct.setResourceIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map164 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32); 
        struct.shareByGroup = new java.util.HashMap<java.lang.String,java.lang.Integer>(2*_map164.size);
        ...
        for (int _i167 = 0; _i167 < _map164.size; ++_i167)
        {
          ...
          struct.shareByGroup.put(_key165, _val166);
        }
      }
      struct.setShareByGroupIsSet(true);
    }
