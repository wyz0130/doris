...
public class TGlobalDict implements org.apache.thrift.TBase<TGlobalDict, TGlobalDict._Fields>, java.io.Serializable, Cloneable, Comparable<TGlobalDict> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.dicts = new java.util.HashMap<java.lang.Integer,TColumnDict>(2*_map126.size);
                int _key127;
                @org.apache.thrift.annotation.Nullable TColumnDict _val128;
                for (int _i129 = 0; _i129 < _map126.size; ++_i129)
                {
                  _key127 = iprot.readI32();
                  _val128 = new TColumnDict();
                  _val128.read(iprot);
                  struct.dicts.put(_key127, _val128);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.slot_dicts = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map130.size);
                int _key131;
                int _val132;
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  ...
                  struct.slot_dicts.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.dicts != null) {
        if (struct.isSetDicts()) {
          oprot.writeFieldBegin(DICTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, TColumnDict> _iter134 : struct.dicts.entrySet())
            {
      ...
      if (struct.slot_dicts != null) {
        if (struct.isSetSlotDicts()) {
          oprot.writeFieldBegin(SLOT_DICTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter135 : struct.slot_dicts.entrySet())
            {
  ...
  private static class TGlobalDictTupleScheme extends org.apache.thrift.scheme.TupleScheme<TGlobalDict> {
      ...
      if (struct.isSetDicts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, TColumnDict> _iter136 : struct.dicts.entrySet())
          {
      ...
      if (struct.isSetSlotDicts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.lang.Integer> _iter137 : struct.slot_dicts.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGlobalDict struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map138 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT); 
          struct.dicts = new java.util.HashMap<java.lang.Integer,TColumnDict>(2*_map138.size);
          int _key139;
          @org.apache.thrift.annotation.Nullable TColumnDict _val140;
          for (int _i141 = 0; _i141 < _map138.size; ++_i141)
          {
            _key139 = iprot.readI32();
            _val140 = new TColumnDict();
            _val140.read(iprot);
            struct.dicts.put(_key139, _val140);
          }
        }
        struct.setDictsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map142 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.I32); 
          struct.slot_dicts = new java.util.HashMap<java.lang.Integer,java.lang.Integer>(2*_map142.size);
          int _key143;
          int _val144;
          for (int _i145 = 0; _i145 < _map142.size; ++_i145)
          {
            ...
            struct.slot_dicts.put(_key143, _val144);
          }
        }
        struct.setSlotDictsIsSet(true);
      }
