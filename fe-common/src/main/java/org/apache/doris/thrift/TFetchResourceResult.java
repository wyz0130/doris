            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resourceByUser = new java.util.HashMap<java.lang.String,TUserResource>(2*_map168.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key169;
                @org.apache.thrift.annotation.Nullable TUserResource _val170;
                for (int _i171 = 0; _i171 < _map168.size; ++_i171)
                {
                  _key169 = iprot.readString();
                  _val170 = new TUserResource();
                  _val170.read(iprot);
                  struct.resourceByUser.put(_key169, _val170);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.resourceByUser != null) {
        oprot.writeFieldBegin(RESOURCE_BY_USER_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, TUserResource> _iter172 : struct.resourceByUser.entrySet())
          {
            oprot.writeString(_iter172.getKey());
            _iter172.getValue().write(oprot);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class TFetchResourceResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFetchResourceResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.resourceVersion);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, TUserResource> _iter173 : struct.resourceByUser.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      struct.setResourceVersionIsSet(true);
      {
        ...
        struct.resourceByUser = new java.util.HashMap<java.lang.String,TUserResource>(2*_map174.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key175;
        @org.apache.thrift.annotation.Nullable TUserResource _val176;
        for (int _i177 = 0; _i177 < _map174.size; ++_i177)
        {
          _key175 = iprot.readString();
          _val176 = new TUserResource();
          _val176.read(iprot);
          struct.resourceByUser.put(_key175, _val176);
        }
      }
      struct.setResourceByUserIsSet(true);
    }
