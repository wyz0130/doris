            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cmp_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list596.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem597;
                for (int _i598 = 0; _i598 < _list596.size; ++_i598)
                {
                  _elem597 = new TEqJoinCondition();
                  _elem597.read(iprot);
                  struct.cmp_conjuncts.add(_elem597);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list599.size);
                @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem600;
                for (int _i601 = 0; _i601 < _list599.size; ++_i601)
                {
                  _elem600 = new org.apache.doris.thrift.TExpr();
                  _elem600.read(iprot);
                  struct.other_join_conjuncts.add(_elem600);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMergeJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.cmp_conjuncts != null) {
        oprot.writeFieldBegin(CMP_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter602 : struct.cmp_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOtherJoinConjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (org.apache.doris.thrift.TExpr _iter603 : struct.other_join_conjuncts)
            {
  ...
  private static class TMergeJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMergeJoinNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TMergeJoinNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (TEqJoinCondition _iter604 : struct.cmp_conjuncts)
        {
      ...
      if (struct.isSetOtherJoinConjuncts()) {
        {
          ...
          for (org.apache.doris.thrift.TExpr _iter605 : struct.other_join_conjuncts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMergeJoinNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.cmp_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list606.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem607;
        for (int _i608 = 0; _i608 < _list606.size; ++_i608)
        {
          _elem607 = new TEqJoinCondition();
          _elem607.read(iprot);
          struct.cmp_conjuncts.add(_elem607);
        }
      }
      struct.setCmpConjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<org.apache.doris.thrift.TExpr>(_list609.size);
          @org.apache.thrift.annotation.Nullable org.apache.doris.thrift.TExpr _elem610;
          for (int _i611 = 0; _i611 < _list609.size; ++_i611)
          {
            _elem610 = new org.apache.doris.thrift.TExpr();
            _elem610.read(iprot);
            struct.other_join_conjuncts.add(_elem610);
          }
        }
        struct.setOtherJoinConjunctsIsSet(true);
      }
