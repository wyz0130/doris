...
public class TBrokerListPathRequest implements org.apache.thrift.TBase<TBrokerListPathRequest, TBrokerListPathRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TBrokerListPathRequest> {
  ...
  private static final org.apache.thrift.protocol.TField ONLY_FILES_FIELD_DESC = new org.apache.thrift.protocol.TField("onlyFiles", org.apache.thrift.protocol.TType.BOOL, (short)6);
  ...
  public boolean onlyFiles; // optional
  ...
  private static final int __ONLYFILES_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.FILE_NAME_ONLY,_Fields.ONLY_FILES};
  ...
  static {
    ...
    tmpMap.put(_Fields.FILE_NAME_ONLY, new org.apache.thrift.meta_data.FieldMetaData("fileNameOnly", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.ONLY_FILES, new org.apache.thrift.meta_data.FieldMetaData("onlyFiles", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TBrokerListPathRequest(TBrokerListPathRequest other) {
    ...
    this.onlyFiles = other.onlyFiles;
  }
  ...
  public TBrokerListPathRequest setOnlyFiles(boolean onlyFiles) {
    this.onlyFiles = onlyFiles;
    setOnlyFilesIsSet(true);
    return this;
  }

  public void unsetOnlyFiles() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ONLYFILES_ISSET_ID);
  }

  /** Returns true if field onlyFiles is set (has been assigned a value) and false otherwise */
  public boolean isSetOnlyFiles() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ONLYFILES_ISSET_ID);
  }

  public void setOnlyFilesIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ONLYFILES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ONLY_FILES:
      if (value == null) {
        ...
        setOnlyFiles((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(TBrokerListPathRequest that) {
    ...
    boolean this_present_onlyFiles = true && this.isSetOnlyFiles();
    boolean that_present_onlyFiles = true && that.isSetOnlyFiles();
    if (this_present_onlyFiles || that_present_onlyFiles) {
      if (!(this_present_onlyFiles && that_present_onlyFiles))
        return false;
      if (this.onlyFiles != that.onlyFiles)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetOnlyFiles()) ? 131071 : 524287);
    if (isSetOnlyFiles())
      hashCode = hashCode * 8191 + ((onlyFiles) ? 131071 : 524287);
  ...
  public int compareTo(TBrokerListPathRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOnlyFiles(), other.isSetOnlyFiles());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOnlyFiles()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.onlyFiles, other.onlyFiles);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TBrokerListPathRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TBrokerListPathRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TBrokerListPathRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 6: // ONLY_FILES
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.onlyFiles = iprot.readBool();
              struct.setOnlyFilesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TBrokerListPathRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOnlyFiles()) {
        oprot.writeFieldBegin(ONLY_FILES_FIELD_DESC);
        oprot.writeBool(struct.onlyFiles);
        oprot.writeFieldEnd();
      }
